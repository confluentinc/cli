#!/bin/sh
set -e
# Code generated by godownloader on 2018-12-17T22:46:27Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for confluentinc/cli
...
execute() {
  ...
  install -d "${BINDIR}"
  for binexe in "ccloud" "ccloud-kafka-plugin" "ccloud-connect-plugin" ; do
    if [ "$OS" = "windows" ]; then
      binexe="${binexe}.exe"
    fi
