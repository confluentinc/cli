...
# Build linux/amd64
docker build . -f ./docker/Dockerfile_linux_glibc_amd64 -t cli-linux-glibc-amd64-builder-image
...
if [ "$architecture" == 'x86_64' ]; then
  docker build . -f ./docker/Dockerfile_linux_glibc_arm64_from_amd64 -t cli-linux-glibc-arm64-builder-image
else
  docker build . -f ./docker/Dockerfile_linux_glibc_arm64 -t cli-linux-glibc-arm64-builder-image
fi
