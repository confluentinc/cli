...
func (s *CLITestSuite) TestSchemaRegistrySchema() {
	tests := []CLITest{
		...
		{args: "schema-registry schema reference list --subject payments", exitCode: 1, fixture: "schema-registry/schema/describe-either-id-or-subject.golden"},
		{args: "schema-registry schema reference list --version 1", exitCode: 1, fixture: "schema-registry/schema/describe-either-id-or-subject.golden"},
		{args: "schema-registry schema reference list", exitCode: 1, fixture: "schema-registry/schema/describe-either-id-or-subject.golden"},
		{args: "schema-registry schema reference list --subject payments --version 1 123", exitCode: 1, fixture: "schema-registry/schema/describe-both-id-and-subject.golden"},
		{args: fmt.Sprintf("schema-registry schema reference list 1001 --environment %s", testserver.SRApiEnvId), fixture: "schema-registry/schema/reference/describe-refs-id.golden"},
		{args: fmt.Sprintf("schema-registry schema reference list --subject lvl0 --version 1 --environment %s", testserver.SRApiEnvId), fixture: "schema-registry/schema/reference/describe-refs-subject.golden"},
	}
