	...
	tests := []CLITest{
		{
			...
			args:        "iam rolebinding create --principal User:bob --role CloudClusterAdmin --environment current --cloud-cluster test-cluster-0",
			login:       "default",
			wantErrCode: 0,
		},
		{
			name:        "ccloud iam rolebinding create, invalid use case: missing cloud-cluster",
			args:        "iam rolebinding create --principal User:bob --role CloudClusterAdmin",
		...
		},
		{
			...
			args:        "iam rolebinding create --principal User:bob --role CloudClusterAdmin --cloud-cluster test-cluster-0",
		...
		{
			name:        "ccloud iam rolebinding create, invalid use case: missing environment",
			args:        "iam rolebinding create --principal User:bob --role EnvironmentAdmin",
			fixture:     "ccloud-iam-rolebinding-missing-environment.golden",
			login:       "default",
			wantErrCode: 1,
		},
		{
			...
			args:        "iam rolebinding delete --principal User:bob --role CloudClusterAdmin --environment current --cloud-cluster test-cluster-0",
			login:       "default",
			wantErrCode: 0,
		},
		{
			name:        "ccloud iam rolebinding delete, invalid use case: missing cloud-cluster",
			args:        "iam rolebinding delete --principal User:bob --role CloudClusterAdmin",
			fixture:     "ccloud-iam-rolebinding-missing-cloud-cluster.golden",
			login:       "default",
			wantErrCode: 1,
		},
		{
			...
			args:        "iam rolebinding delete --principal User:bob --role CloudClusterAdmin --cloud-cluster test-cluster-0",
			fixture:     "ccloud-iam-rolebinding-missing-environment.golden",
			login:       "default",
			wantErrCode: 1,
		},
		{
			name:        "ccloud iam rolebinding delete, invalid use case: missing environment",
			args:        "iam rolebinding delete --principal User:bob --role EnvironmentAdmin",
			fixture:     "ccloud-iam-rolebinding-missing-environment.golden",
			login:       "default",
			wantErrCode: 1,
		},
