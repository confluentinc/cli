	...
	tests := []CLITest{
		{
			...
			args:        "iam rolebinding create --principal User:bob --role CloudClusterAdmin --kafka-cluster-id kafka-GUID",
			login:       "default",
			wantErrCode: 0,
		},
		{
		...
		},
		{
			...
			args:        "iam rolebinding delete --principal User:bob --role CloudClusterAdmin --kafka-cluster-id kafka-GUID",
			login:       "default",
			wantErrCode: 0,
		},
		{
