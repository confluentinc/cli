...
func (s *CLITestSuite) Test_Ccloud_Iam_Role_Binding_CRUD() {
	tests := []CLITest{
		...
		{
			name:        "ccloud iam rolebinding create, invalid use case: cluster-name & kafka-cluster-id specified",
		...
		{
			name:        "ccloud iam rolebinding create, invalid use case: cluster-name & ksql-cluster-id specified",
		 ...
		 */
		{
			...
			fixture:     "ccloud-iam-rolebinding-missing-name-or-id.golden",
			login:       "default",
			wantErrCode: 1,
		},
		{
			name:        "ccloud iam rolebinding create, invalid use case: missing  kafka-cluster-id",
			...
			fixture:     "ccloud-iam-rolebinding-missing-kafka-cluster-id.golden",
			login:       "default",
			wantErrCode: 1,
		},
		{
			name:        "ccloud iam rolebinding create, invalid use case: multiple non kafka id",
			...
			fixture:     "ccloud-iam-rolebinding-multiple-non-kafka-id.golden",
			login:       "default",
			wantErrCode: 1,
		},
		{
		...
		{
			name:        "ccloud iam rolebinding delete, invalid use case: cluster-name & kafka-cluster-id specified",
		...
		{
			name:        "ccloud iam rolebinding delete, invalid use case: cluster-name & ksql-cluster-id specified",
		...
		{
			name:        "ccloud iam rolebinding delete, invalid use case: missing cluster-name or cluster-id",
		...
		{
			name:        "ccloud iam rolebinding delete, invalid use case: missing  kafka-cluster-id",
		...
		{
			name:        "ccloud iam rolebinding delete, invalid use case: multiple non kafka id",
