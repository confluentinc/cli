...
func (s *CLITestSuite) TestUsmConnect() {
	tests := []CLITest{
		...
		{args: "usm connect register connect-group-xyz123 --cloud aws --region us-east-1", fixture: "unified-stream-manager/connect/create-fail-missing-kafka-flag.golden", exitCode: 1},
