...
func (s *CLITestSuite) TestCustomCodeLogging() {
	tests := []CLITest{
		// create
		{args: `custom-code-logging create --cloud AWS --region us-west-2 --environment env-000000 --topic topic-123 --cluster-id cluster-123`, fixture: "custom-code-logging/create.golden"},
		//create - missing cloud
		{args: `custom-code-logging create --region us-west-2 --environment env-000000 --topic topic-123 --cluster-id cluster-123`, fixture: "custom-code-logging/create-no-cloud.golden", exitCode: 1},
		// create - missing region
		{args: `custom-code-logging create --cloud AWS --environment env-000000--topic topic-123 --cluster-id cluster-123`, fixture: "custom-code-logging/create-no-region.golden", exitCode: 1},
		// create - missing environment
		{args: `custom-code-logging create --cloud AWS --region us-west-2 --topic topic-123 --cluster-id cluster-123`, fixture: "custom-code-logging/create-no-env.golden", exitCode: 1},
		// create - missing destination topic
		{args: `custom-code-logging create --cloud AWS --region us-west-2 --environment env-000000 --cluster-id cluster-123`, fixture: "custom-code-logging/create-no-topic.golden", exitCode: 1},
		// create - missing destination cluster id
		{args: `custom-code-logging create --cloud AWS --region us-west-2 --environment env-000000 --topic topic-123`, fixture: "custom-code-logging/create-no-clusterid.golden", exitCode: 1},
		...
		// update
		{args: "custom-code-logging update ccl-123456 --log-level ERROR", fixture: "custom-code-logging/update.golden"},
		// update - no updates
