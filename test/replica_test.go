...
func (s *CLITestSuite) TestReplicas() {
	...
	tests := []CLITest{
		...
		{args: "kafka replica list --topic topic-exist --partition 2", fixture: "kafka/replicas/list-partition-replicas-yaml.golden"},
		...
		{args: "kafka replica list --broker 1", fixture: "kafka/replicas/list-broker-json.golden"},
