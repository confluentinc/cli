...
func (s *CLITestSuite) TestFlinkMaterializedTableCreate() {
	...
	tests := []CLITest{
		{args: "flink region use --cloud aws --region eu-west-1", fixture: "flink/region/use-aws.golden"},
		{args: "flink endpoint use http://127.0.0.1:1026", fixture: "flink/endpoint/use-public.golden"},
		{args: "flink materialized-table create my-table --cloud aws --region eu-west-1 --kafka-cluster-id lkc01 --compute-pool pool1 --principal principal1 --query query1 ", fixture: "flink/materialized-table/create/create.golden"},
		{args: fmt.Sprintf("flink materialized-table create my-table --cloud aws --region eu-west-1 "+
			"--kafka-cluster-id lkc01 --compute-pool pool1 --principal principal1 "+
...
func (s *CLITestSuite) TestFlinkMaterializedTableDescribe() {
	tests := []CLITest{
		{args: "flink region use --cloud aws --region eu-west-1", fixture: "flink/region/use-aws.golden"},
		{args: "flink endpoint use http://127.0.0.1:1026", fixture: "flink/endpoint/use-public.golden"},
		{args: "flink materialized-table describe my-table --cloud aws --region eu-west-1 --kafka-cluster-id lkc01", fixture: "flink/materialized-table/describe/describe.golden"},
...
func (s *CLITestSuite) TestFlinkMaterializedTableDelete() {
	tests := []CLITest{
		{args: "flink region use --cloud aws --region eu-west-1", fixture: "flink/region/use-aws.golden"},
		{args: "flink endpoint use http://127.0.0.1:1026", fixture: "flink/endpoint/use-public.golden"},
		{args: "flink materialized-table delete my-table --cloud aws --region eu-west-1 --kafka-cluster-id lkc01", input: "y\n", fixture: "flink/materialized-table/delete/delete.golden"},
	}
...
func (s *CLITestSuite) TestFlinkMaterializedTableUpdate() {
	...
	tests := []CLITest{
		{args: "flink region use --cloud aws --region eu-west-1", fixture: "flink/region/use-aws.golden"},
		{args: "flink endpoint use http://127.0.0.1:1026", fixture: "flink/endpoint/use-public.golden"},
		{args: "flink materialized-table update my-table-1 --cloud aws --region eu-west-1 --kafka-cluster-id lkc01 --compute-pool pool1 --principal principal1 --query query2", fixture: "flink/materialized-table/update/update.golden"},
		{args: "flink materialized-table update my-table-1 --cloud aws --region eu-west-1 --kafka-cluster-id lkc01 --compute-pool pool2 --principal principal1 --query query1", fixture: "flink/materialized-table/update/update-2.golden"},
		{args: "flink materialized-table update my-table-1 --cloud aws --region eu-west-1 --kafka-cluster-id lkc01 --principal principal1 --query query1", fixture: "flink/materialized-table/update/no-cp.golden"},
		{args: fmt.Sprintf("flink materialized-table update my-table-1 --cloud aws --region eu-west-1 --kafka-cluster-id lkc01 --compute-pool pool2 --principal principal1 --query query1 --watermark-expression expNew --constraints %s --columns-physical %s", fileConstraints.Name(), file.Name()), fixture: "flink/materialized-table/update/update-3.golden"},
		{args: "flink materialized-table update my-table-1 --cloud aws --region eu-west-1 --kafka-cluster-id lkc01 --stopped=true", fixture: "flink/materialized-table/update/stop.golden"},
		{args: "flink materialized-table update my-table-1 --cloud aws --region eu-west-1 --kafka-cluster-id lkc01 --stopped=false", fixture: "flink/materialized-table/update/resume.golden"},
	}
