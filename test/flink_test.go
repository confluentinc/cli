...
func (s *CLITestSuite) TestFlinkConnectionCreateFailure() {
	tests := []CLITest{
		...
		{args: "flink connection create my-connection --cloud aws --region eu-west-1 --type openai --endpoint https://api.openai.com/v1/chat/completions --username username --password password", fixture: "flink/connection/create/create-wrong-secret-type.golden", exitCode: 1},
		{args: "flink connection create my-connection --cloud aws --region eu-west-1 --type openai --endpoint https://api.openai.com/v1/chat/completions --no-auth", fixture: "flink/connection/create/create-no-auth-not-supported.golden", exitCode: 1},
...
func (s *CLITestSuite) TestFlinkConnectionCreateSuccess() {
	tests := []CLITest{
		...
		{args: "flink connection create my-connection --cloud aws --region eu-west-1 --type rest --endpoint https://api.example.com --no-auth", fixture: "flink/connection/create/create-rest.golden"},
		...
		{args: "flink connection create my-connection --cloud aws --region eu-west-1 --type mcp_server --endpoint https://api.example.com --no-auth", fixture: "flink/connection/create/create-mcp_server.golden"},
	}
