...
func (s *CLITestSuite) TestFlinkArtifact() {
	tests := []CLITest{
		...
		{args: "flink artifact create my-flink-artifact --artifact-file test/fixtures/input/flink/python-udf-examples.zip --description cliPluginTest --runtime-lang python", fixture: "flink/artifact/create-python.golden"},
