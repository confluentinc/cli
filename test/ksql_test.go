...
func (s *CLITestSuite) TestKSQL() {
	...
	appTests := []CLITest{
		...
		{args: "ksql app create test_ksql --cluster lkc-processLogFalse --api-key key --api-secret secret --hide-rows-in-processing-log", fixture: "ksql/app-create-hide-processing-row-result.golden"},
		{args: "ksql app create test_ksql_json --cluster lkc-processLogFalse --api-key key --api-secret secret --hide-rows-in-processing-log -o json", fixture: "ksql/app-create-result-json-hide-rows-in-processing-log.golden"},
		{args: "ksql app create test_ksql_yaml --cluster lkc-processLogFalse --api-key key --api-secret secret --hide-rows-in-processing-log -o yaml", fixture: "ksql/app-create-result-yaml-hide-rows-in-processing-log.golden"},
	...
	clusterTests := []CLITest{
		...
		{args: "ksql cluster create test_ksql --cluster lkc-processLogFalse --api-key key --api-secret secret --hide-rows-in-processing-log", fixture: "ksql/cluster-create-result-hide-rows-in-processing-log.golden"},
		{args: "ksql cluster create test_ksql_json --cluster lkc-processLogFalse --api-key key --api-secret secret --hide-rows-in-processing-log -o json", fixture: "ksql/cluster-create-result-json-hide-rows-in-processing-log.golden"},
		{args: "ksql cluster create test_ksql_yaml --cluster lkc-processLogFalse --api-key key --api-secret secret --hide-rows-in-processing-log -o yaml", fixture: "ksql/cluster-create-result-yaml-hide-rows-in-processing-log.golden"},
