...
func (s *CLITestSuite) TestKSQL() {
	...
	appTests := []CLITest{
		...
		{args: "ksql app create test_ksql --cluster lkc-12345", fixture: "ksql/app/create-result-missing-credential-identity.golden", wantErrCode: 1},
		{args: "ksql app create test_ksql --cluster lkc-12345 --credential-identity sa-credential-identity", fixture: "ksql/app/create-result.golden"},
		{args: "ksql app create test_ksql_json --cluster lkc-12345 --credential-identity sa-credential-identity -o json", fixture: "ksql/app/create-result-json.golden"},
		{args: "ksql app create test_ksql_yaml --cluster lkc-12345 --credential-identity sa-credential-identity -o yaml", fixture: "ksql/app/create-result-yaml.golden"},
		{args: "ksql app create test_ksql --cluster lkc-processLogFalse --credential-identity sa-credential-identity --log-exclude-rows", fixture: "ksql/app/create-log-exclude-rows-result.golden"},
		{args: "ksql app create test_ksql_json --cluster lkc-processLogFalse --credential-identity sa-credential-identity --log-exclude-rows -o json", fixture: "ksql/app/create-result-json-log-exclude-rows.golden"},
		{args: "ksql app create test_ksql_yaml --cluster lkc-processLogFalse --credential-identity sa-credential-identity --log-exclude-rows -o yaml", fixture: "ksql/app/create-result-yaml-log-exclude-rows.golden"},
