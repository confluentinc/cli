...
func (s *CLITestSuite) TestKSQL() {
	...
	clusterTests := []CLITest{
		...
		{args: "ksql cluster create test_ksql --cluster lkc-12345 --credential-identity sa-credential-identity", env: []string{"XX_SR_RBAC_ENABLE=1"}, fixture: "ksql/cluster/create-result-rbac-stage3.golden"},
