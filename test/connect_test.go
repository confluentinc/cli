...
func (s *CLITestSuite) TestConnect() {
	...
	tests := []CLITest{
		...
		{args: "connect create --cluster lkc-123 --config-file test/fixtures/input/connect/config.yaml -o json", fixture: "connect/create-json.golden"},
		{args: "connect create --cluster lkc-123 --config-file test/fixtures/input/connect/config.yaml -o yaml", fixture: "connect/create-yaml.golden"},
		{args: "connect create --cluster lkc-123 --config-file test/fixtures/input/connect/config.yaml", fixture: "connect/create.golden"},
		...
		{args: "connect update lcc-123 --cluster lkc-123 --config-file test/fixtures/input/connect/config.yaml", fixture: "connect/update.golden"},
		{args: "connect event describe", fixture: "connect/event-describe.golden"},

		//Tests based on new config
		{args: "connect create --cluster lkc-123 --config-file test/fixtures/input/connect/config-new-format.json -o json", fixture: "connect/create-new-config-json.golden"},
		{args: "connect create --cluster lkc-123 --config-file test/fixtures/input/connect/config-new-format.json -o yaml", fixture: "connect/create-yaml.golden"},
		{args: "connect update lcc-123 --cluster lkc-123 --config-file test/fixtures/input/connect/config-new-format.json", fixture: "connect/update.golden"},
	}
