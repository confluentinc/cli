...
func (s *CLITestSuite) TestConnectLogs() {
	...
	tests := []CLITest{
		...
		{args: fmt.Sprintf("connect logs lcc-123 --cluster lkc-123 --start-time 2025-01-02T15:04:05Z --end-time 2025-01-02T15:14:05Z --level INFO"), fixture: "connect/logs/logs-starttime-older-than-72-hours.golden", exitCode: 1},
	}
