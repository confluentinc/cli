...
func (s *CLITestSuite) TestConnectArtifact() {
	// TODO: add --config flag to all commands or ENVVAR instead of using standard config file location
	tests := []CLITest{
		{args: `connect artifact create my-connect-artifact --artifact-file artifact.jar --cloud aws --region us-west-2 --environment env-123456 --description new-jar-artifact`, fixture: "connect/artifact/create-jar.golden"},
		{args: `connect artifact create my-connect-artifact --artifact-file artifact.zip --cloud aws --region us-west-2 --environment env-123456 --description new-zip-artifact`, fixture: "connect/artifact/create-zip.golden"},
		{args: `connect artifact create my-connect-artifact --artifact-file artifact.zip --cloud azure --region us-west-2 --environment env-123456 --description new-invalid-artifact`, fixture: "connect/artifact/create-invalid-cloud-type.golden", exitCode: 1},
		{args: `connect artifact create my-connect-artifact --artifact-file artifact.jpg --cloud aws --region us-west-2 --environment env-123456 --description new-invalid-artifact`, fixture: "connect/artifact/create-invalid-file-type.golden", exitCode: 1},
		{args: "connect artifact list", fixture: "connect/custom-plugin/list.golden"},
		{args: "connect artifact list --cloud aws --region us-west-2 --environment env-123456", fixture: "connect/custom-plugin/list.golden"},
		{args: "connect artifact list --cloud aws --region us-west-2 --environment env-123456 -o json", fixture: "connect/custom-plugin/list-json.golden"},
		{args: "connect artifact list --cloud aws --region us-west-2 --environment env-123456 -o yaml", fixture: "connect/custom-plugin/list-yaml.golden"},
		{args: "connect artifact describe cfa-zip123 --cloud aws --region us-west-2 --environment env-123456", fixture: "connect/custom-plugin/describe-zip.golden"},
		{args: "connect artifact describe cfa-jar123 --cloud aws --region us-west-2 --environment env-123456", fixture: "connect/custom-plugin/describe-jar.golden"},
		{args: "connect artifact describe cfa-jar123 --cloud aws --region us-west-2 --environment env-123456 -o json", fixture: "connect/custom-plugin/describe-json.golden"},
		{args: "connect artifact describe cfa-jar123 --cloud aws --region us-west-2 --environment env-123456 -o yaml", fixture: "connect/custom-plugin/describe-yaml.golden"},
		{args: "connect artifact describe cfa-zip123 --cloud aws --region us-west-2 --environment env-123456", fixture: "connect/custom-plugin/describe-nonexistent-artifact.golden", exitCode: 1},
		{args: "connect artifact delete cfa-zip123 --cloud aws --region us-west-2 --force", fixture: "connect/custom-plugin/delete-force.golden"},
		{args: "connect artifact delete cfa-zip123 --cloud aws --region us-west-2", input: "y\n", fixture: "connect/custom-plugin/delete-prompt.golden"},
	}
