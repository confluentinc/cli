...
func (s *CLITestSuite) TestConnectCustomPluginVersioning() {
	tests := []CLITest{
		{args: `connect custom-plugin version create --plugin plugin123 --plugin-file "test/fixtures/input/connect/confluentinc-kafka-connect-datagen-0.6.1.zip" --version-number 0.0.1 `, fixture: "connect/custom-plugin/version/create-version.golden"},
		{args: `connect custom-plugin version create --plugin plugin123 --plugin-file "test/fixtures/input/connect/confluentinc-kafka-connect-datagen-0.6.1.zip" --version-number 0.0.1 `, fixture: "connect/custom-plugin/version/create-version.golden"},
		{args: `connect custom-plugin version create --plugin plugin123 --plugin-file "test/fixtures/input/connect/confluentinc-kafka-connect-datagen-0.6.1.pdf" --version-number 0.0.1 `, fixture: "connect/custom-plugin/version/create-version-invalid-extension.golden", exitCode: 1},
		{args: "connect custom-plugin version list --plugin plugin23", fixture: "connect/custom-plugin/version/list-version.golden"},
		{args: "connect custom-plugin version list --plugin plugin23 -o json", fixture: "connect/custom-plugin/version/list-version-json.golden"},
		{args: "connect custom-plugin version list --plugin plugin23 -o yaml", fixture: "connect/custom-plugin/version/list-version-yaml.golden"},
		{args: "connect custom-plugin version describe --plugin ccp-123456 --version ver-123456", fixture: "connect/custom-plugin/version/describe-version.golden"},
		{args: "connect custom-plugin version describe --plugin ccp-789012 --version ver-789012", fixture: "connect/custom-plugin/version/describe-version-with-sensitive-properties.golden"},
		{args: "connect custom-plugin version describe --plugin ccp-123456 --version ver-123456 -o json", fixture: "connect/custom-plugin/version/describe-version-json.golden"},
		{args: "connect custom-plugin version describe --plugin ccp-123456 --version ver-123456 -o yaml", fixture: "connect/custom-plugin/version/describe-version-yaml.golden"},
		{args: "connect custom-plugin version delete --plugin ccp-123456 --version version-123456 --force", fixture: "connect/custom-plugin/version/delete-version.golden"},
		{args: "connect custom-plugin version delete --plugin ccp-123456 --version version-123456", input: "version-123456\n", fixture: "connect/custom-plugin/version/delete-version-prompt.golden"},
		{args: "connect custom-plugin version update --plugin ccp-123456 --version ver-123456 --version-number 0.0.1 ", fixture: "connect/custom-plugin/version/update-version.golden"},
	}
