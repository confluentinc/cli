...
func (s *CLITestSuite) TestConnect() {
	...
	tests := []CLITest{
		...
		{args: "connect create --cluster lkc-123 --config test/fixtures/input/connect-config.yaml -o json", fixture: "connect/connect-create-json.golden"},
		{args: "connect create --cluster lkc-123 --config test/fixtures/input/connect-config.yaml -o yaml", fixture: "connect/connect-create-yaml.golden"},
		{args: "connect create --cluster lkc-123 --config test/fixtures/input/connect-config.yaml", fixture: "connect/connect-create.golden"},
		...
		{args: "connect update lcc-123 --cluster lkc-123 --config test/fixtures/input/connect-config.yaml", fixture: "connect/connect-update.golden"},
		{args: "connect event describe", fixture: "connect/connect-event-describe.golden"},

		//Tests based on new config
		{args: "connect create --cluster lkc-123 --config test/fixtures/input/connect-config-new-format.json -o json", fixture: "connect/connect-create-new-config-json.golden"},
		{args: "connect create --cluster lkc-123 --config test/fixtures/input/connect-config-new-format.json -o yaml", fixture: "connect/connect-create-yaml.golden"},
		{args: "connect update lcc-123 --cluster lkc-123 --config test/fixtures/input/connect-config-new-format.json", fixture: "connect/connect-update.golden"},
	}
