...
func (s *CLITestSuite) TestIAMRBACRoleBindingListCloud() {
	tests := []CLITest{
		...
		{args: "iam rbac role-binding list --environment a-595 --cloud-cluster lkc-1111aaa --role OrganisationAdmin", fixture: "iam/rbac/role-binding/list-invalid-role-error-type-1-cloud.golden", wantErrCode: 1},
		{args: "iam rbac role-binding list --environment a-595 --cloud-cluster lkc-1111aaa --role MetricsViewers", fixture: "iam/rbac/role-binding/list-invalid-role-error-type-2-cloud.golden", wantErrCode: 1},
	}
