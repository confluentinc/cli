...
func (s *CLITestSuite) TestIamServiceAccount() {
	tests := []CLITest{
		...
		{args: "iam service-account list --display-name service-account", fixture: "iam/service-account/list-display-name.golden"},
		{args: "iam service-account list --display-name service-account,other-service-account", fixture: "iam/service-account/list-display-name-multiple.golden"},
		{args: "iam service-account list --display-name nonexistent", fixture: "iam/service-account/list-display-name-no-match.golden"},
...
func (s *CLITestSuite) TestIamCertificateAuthority() {
	tests := []CLITest{
		{args: `iam certificate-authority create my-ca --description "my certificate authority" --certificate-chain ABC123 --certificate-chain-filename certificate.pem --require-crl-on-client-cert`, fixture: "iam/certificate-authority/create.golden"},
		{args: `iam certificate-authority create my-ca --description "my certificate authority" --certificate-chain ABC123 --certificate-chain-filename certificate.pem --crl-chain DEF456 --require-crl-on-client-cert`, fixture: "iam/certificate-authority/create-url-chain.golden"},
