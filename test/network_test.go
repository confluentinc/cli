...
func (s *CLITestSuite) TestAll() {
	...
	s.TestNetworkRegionList()
	s.TestNetworkIpAddressList()
	s.TestNetworkNetworkLinkServiceAssociationDescribe()
	s.TestNetworkNetworkLinkServiceAssociationList()
	s.TestNetworkNetworkLinkServiceAssociation_Autocomplete()
	s.TestNetworkDnsForwarderDescribe()
	s.TestNetworkDnsForwarderList()
	s.TestNetworkDnsForwarderDelete()
	s.TestNetworkDnsForwarderUpdate()
	s.TestNetworkDnsForwarderCreate()
