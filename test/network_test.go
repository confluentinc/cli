...
func (s *CLITestSuite) TestNetworkDnsForwarderUpdate() {
	tests := []CLITest{
		...
		{args: "network dns forwarder create my-dns-forwarder-file --gateway gw-123456 --domains abc.com,def.com,xyz.com --domain-mapping " + getCreateForwarderConfigFile(), fixture: "network/dns/forwarder/create_file.golden"},
		{args: "network dns forwarder update my-dns-forwarder-file --domain-mapping " + getUpdateForwarderConfigFile(), fixture: "network/dns/forwarder/update-mappings.golden"},
