...
func (s *CLITestSuite) TestNetworkCreate() {
	tests := []CLITest{
		...
		{args: "network create aws-pl --cloud aws --region us-west-2 --connection-types privatelink --zones usw2-az1,usw2-az2,usw2-az3 --dns-resolution priva --environment env-00000", fixture: "network/create-pl-invalid-dns-resolution.golden", exitCode: 1},
