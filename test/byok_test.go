...
func (s *CLITestSuite) TestBYOK() {
	tests := []CLITest{
		...
		{args: "byok register https://a-vault.vault.azure.net/keys/a-key/00000000000000000000000000000000 --tenant-id 00000000-0000-0000-0000-000000000000 --key-vault-id /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/a-resourcegroups/providers/Microsoft.KeyVault/vaults/a-vault", fixture: "byok/3.golden"},
		{args: "byok list", fixture: "byok/4.golden"},
		{args: "byok register https://a-vault.vault.azure.net/keys/a-key/00000000000000000000000000000000 --tenant-id 00000000-0000-0000-0000-000000000000", fixture: "byok/5.golden", wantErrCode: 1},
