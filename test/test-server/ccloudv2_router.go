...
var ccloudV2Routes = []route{
	...
	{"/notifications/v1/integrations", handleNotificationsV1Integrations},
	{"/notifications/v1/integrations/{id}", handleNotificationsV1IntegrationsId},
	...
	{"/notifications/v1/resource-preferences", handleNotificationsV1ResourcePreferences},
	{"/notifications/v1/resource-preferences/{id}", handleNotificationsV1ResourcePreferencesId},
	{"/notifications/v1/resource-subscriptions", handleNotificationsV1ResourceSubscriptions},
	{"/notifications/v1/resource-subscriptions/{id}", handleNotificationsV1ResourceSubscriptionsId},
	{"/notifications/v1/subscriptions", handleNotificationsV1Subscriptions},
	{"/notifications/v1/subscriptions/{id}", handleNotificationsV1SubscriptionsId},
	{"/notifications/v1/user-notifications", handleNotificationsV1UserNotifications},
	{"/notifications/v1/user-notifications/{id}", handleNotificationsV1UserNotificationsId},
