	...
	return srcmv3.SrcmV3Cluster{
		...
		Spec: &srcmv3.SrcmV3ClusterSpec{
			...
			PrivateNetworkingConfig: &srcmv3.SrcmV3ClusterSpecPrivateNetworkingConfig{
				&map[string]string{"us-east-1": "https://lsrc-stk1d.us-east-1.aws.private.stag.cpdev.cloud", "us-west-2": "https://lsrc-stgvk1d.us-west-2.aws.private.stag.cpdev.cloud"},
			},
