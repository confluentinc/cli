...
var flinkRoutes = []route{
	...
	{"/cmf/api/v1/environments/{environment}/artifacts", handleCmfArtifacts},
	{"/cmf/api/v1/environments/{environment}/artifacts/{artifactName}", handleCmfArtifact},
	{"/cmf/api/v1/environments/{environment}/artifacts/{artifactName}/versions", handleCmfArtifactVersions},
	{"/cmf/api/v1/environments/{environment}/artifacts/{artifactName}/content", handleCmfArtifactContent},
