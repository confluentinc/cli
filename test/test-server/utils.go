...
var (
	...
	clusterInvalidUpdateMsg     = `{"errors":[{"status":"400","detail":"your cluster update config is invalid. Please check documentation for more details, for example, multi-zone clusters cannot be downscaled below 2 CKUs"}]}`
)
