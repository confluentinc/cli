...
func (s *CLITestSuite) TestStreamShare() {
	tests := []CLITest{
		...
		{args: "stream-share provider share delete ss-12345", preCmdFuncs: []bincover.PreCmdFunc{stdinPipeFunc(strings.NewReader("y\n"))}, fixture: "stream-share/delete-provider-share-prompt.golden"},
		...
		{args: "stream-share consumer share delete ss-12345", preCmdFuncs: []bincover.PreCmdFunc{stdinPipeFunc(strings.NewReader("y\n"))}, fixture: "stream-share/delete-consumer-share-prompt.golden"},
