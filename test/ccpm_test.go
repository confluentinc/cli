...
func (s *CLITestSuite) TestCCPMPlugin() {
	tests := []CLITest{
		...
		// Plugin create tests
		{args: "ccpm plugin create --name my-custom-plugin --description 'Test plugin' --cloud aws --environment env-123456", fixture: "ccpm/plugin-create.golden"},
...
func (s *CLITestSuite) TestCCPMPluginVersion() {
	tests := []CLITest{
		...
		// Version describe tests
		{args: "ccpm plugin version describe --plugin ccp-123456 --version ver-123456 --environment env-123456", fixture: "ccpm/plugin-version-describe.golden"},
		{args: "ccpm plugin version describe --plugin ccp-123456 --version ver-123456 --environment env-123456 -o json", fixture: "ccpm/plugin-version-describe-json.golden"},
		{args: "ccpm plugin version describe --plugin ccp-123456 --version ver-123456 --environment env-123456 -o yaml", fixture: "ccpm/plugin-version-describe-yaml.golden"},
		{args: "ccpm plugin version describe --plugin ccp-123456 --version invalid-version --environment env-123456", fixture: "ccpm/plugin-version-describe-not-found.golden", exitCode: 1},

		// Version delete tests
		{args: "ccpm plugin version delete --plugin ccp-123456 --version ver-123456 --environment env-123456 --force", fixture: "ccpm/plugin-version-delete.golden"},
		{args: "ccpm plugin version delete --plugin ccp-123456 --version ver-123456 --environment env-123456", input: "y\n", fixture: "ccpm/plugin-version-delete-prompt.golden"},
		{args: "ccpm plugin version delete --plugin ccp-123456 --version ver-123456 --environment env-123456", input: "n\n", fixture: "ccpm/plugin-version-delete-cancelled.golden"},
		{args: "ccpm plugin version delete --plugin ccp-123456 --version invalid-version --environment env-123456 --force", fixture: "ccpm/plugin-version-delete-not-found.golden", exitCode: 1},
	}
...
func (s *CLITestSuite) TestCCPMValidation() {
	tests := []CLITest{
		...
		{args: "ccpm plugin version describe --version ver-123456", fixture: "ccpm/plugin-version-describe-missing-plugin.golden", exitCode: 1},
		{args: "ccpm plugin version delete --plugin ccp-123456", fixture: "ccpm/plugin-version-delete-missing-version.golden", exitCode: 1},
		{args: "ccpm plugin version delete --version ver-123456", fixture: "ccpm/plugin-version-delete-missing-plugin.golden", exitCode: 1},
	}
...
func (s *CLITestSuite) TestCCPMErrorHandling() {
	tests := []CLITest{
		...
		{args: "ccpm plugin list --environment env-123456", fixture: "ccpm/plugin-list-api-error.golden", exitCode: 1},
		{args: "ccpm plugin create --name my-plugin --cloud aws --environment env-123456", fixture: "ccpm/plugin-create-api-error.golden", exitCode: 1},
		{args: "ccpm plugin describe ccp-123456 --environment env-123456", fixture: "ccpm/plugin-describe-api-error.golden", exitCode: 1},
		{args: "ccpm plugin update ccp-123456 --name updated-name --environment env-123456", fixture: "ccpm/plugin-update-api-error.golden", exitCode: 1},
		{args: "ccpm plugin delete ccp-123456 --environment env-123456 --force", fixture: "ccpm/plugin-delete-api-error.golden", exitCode: 1},
...
func (s *CLITestSuite) TestCCPMFeatureFlag() {
	// Test that CCPM command is hidden when feature flag is disabled
	tests := []CLITest{
		{args: "ccpm --help", fixture: "ccpm/help-disabled.golden", exitCode: 1},
	}

	// Disable the feature flag for this test
	s.T().Setenv("CONFLUENT_CLI_FEATURE_FLAGS", "custom-connect.plugin.enabled=false")
