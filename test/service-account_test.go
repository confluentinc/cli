...
func (s *CLITestSuite) TestServiceAccount() {
	tests := []CLITest{
		...
		{args: "service-account delete sa-55555", fixture: "service-account/service-account-delete.golden"},
		...
		{args: "service-account update sa-55555 --description new-description", fixture: "service-account/service-account-update.golden"},
	}
