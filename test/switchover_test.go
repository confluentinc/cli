...
func (s *CLITestSuite) TestSwitchover() {
	tests := []CLITest{
		...
		{args: "switchover pair describe sw-123456 --output yaml", fixture: "switchover/pair/describe-yaml.golden"},
		{args: "switchover pair update sw-123456 --display-name renamed-dr", fixture: "switchover/pair/update.golden"},
		{args: "switchover pair failover sw-123456 --active-member east --failover-type UNPLANNED --force", fixture: "switchover/pair/failover.golden"},
		...
		{args: "switchover endpoint describe se-123456 --output yaml", fixture: "switchover/endpoint/describe-yaml.golden"},
