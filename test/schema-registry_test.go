...
func (s *CLITestSuite) TestSchemaRegistry() {
	...
	tests := []CLITest{
...

		{
			...
			args: "schema-registry schema create --subject payments --schema="+schemaPath+" --api-key key --api-secret secret --environment="+test_server.SRUpdateEnvId,
			fixture: "schema-registry/schema-registry-schema-create.golden",
		},
		{
			name: "schema-registry schema delete latest",
			args: "schema-registry schema delete --subject payments --version latest --api-key key --api-secret secret --environment="+test_server.SRUpdateEnvId,
			fixture: "schema-registry/schema-registry-schema-delete.golden",
		},
		{
			name: "schema-registry schema delete all",
			args: "schema-registry schema delete --subject payments --version all --api-key key --api-secret secret --environment="+test_server.SRUpdateEnvId,
		...
		},
		{
			...
			args: "schema-registry schema describe --subject payments --version 2 --api-key key --api-secret secret --environment="+test_server.SRUpdateEnvId,
			fixture: "schema-registry/schema-registry-schema-describe.golden",
		},
		{
			name: "schema-registry schema describe by id",
			args: "schema-registry schema describe 10 --api-key key --api-secret secret --environment="+test_server.SRUpdateEnvId,
			fixture: "schema-registry/schema-registry-schema-describe.golden",
		},

		{
			name: "schema-registry subject list",
			args: "schema-registry subject list --api-key=key --api-secret=secret --environment="+test_server.SRUpdateEnvId,
			fixture: "schema-registry/schema-registry-subject-list.golden",
		},
		{
			name: "schema-registry subject describe testSubject",
			args: "schema-registry subject describe testSubject --api-key=key --api-secret=secret --environment="+test_server.SRUpdateEnvId,
			fixture: "schema-registry/schema-registry-subject-describe.golden",
		},
		{
			name: "schema-registry subject update compatibility",
			args: "schema-registry subject update testSubject --compatibility BACKWARD --api-key=key --api-secret=secret --environment="+test_server.SRUpdateEnvId,
			fixture: "schema-registry/schema-registry-subject-update-compatibility.golden",
		},
		{
			name: "schema-registry subject update mode",
			args: "schema-registry subject update testSubject --mode READ --api-key=key --api-secret=secret --environment="+test_server.SRUpdateEnvId,
