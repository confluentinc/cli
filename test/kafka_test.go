...
func (s *CLITestSuite) TestCCloudKafkaConsumerGroup() {
	tests := []CLITest{
		...
		{args: "kafka consumer-group list", fixture: "kafka/consumer-group-list-no-flag.golden", wantErrCode: 1, env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group list", fixture: "kafka/rest-proxy-not-available.golden", wantErrCode: 1},
		{args: "kafka consumer-group list --cluster lkc-groups", fixture: "kafka/consumer-group-list-success.golden", wantErrCode: 0, env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group list --cluster lkc-groups", fixture: "kafka/rest-proxy-not-available.golden", wantErrCode: 1},
		...
		{args: "kafka consumer-group list --cluster lkc-groups -o json", fixture: "kafka/rest-proxy-not-available.golden", wantErrCode: 1},
		...
		{args: "kafka consumer-group describe", fixture: "kafka/consumer-group-describe-no-args.golden", wantErrCode: 1, env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group describe", fixture: "kafka/consumer-group-describe-no-args.golden", wantErrCode: 1},
		{args: "kafka consumer-group describe --cluster lkc-groups", fixture: "kafka/consumer-group-describe-no-args.golden", wantErrCode: 1, env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group describe --cluster lkc-groups", fixture: "kafka/consumer-group-describe-no-args.golden", wantErrCode: 1},
		{args: "kafka consumer-group describe consumer-group-1", fixture: "kafka/consumer-group-describe-no-flag.golden", wantErrCode: 1, env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group describe consumer-group-1", fixture: "kafka/rest-proxy-not-available.golden", wantErrCode: 1},
		...
		{args: "kafka consumer-group describe consumer-group-1 --cluster lkc-groups", fixture: "kafka/rest-proxy-not-available.golden", wantErrCode: 1},
		...
		{args: "kafka consumer-group lag summarize", fixture: "kafka/consumer-group-lag-summarize-no-args.golden", wantErrCode: 1, env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group lag summarize consumer-group-1 --cluster lkc-groups", fixture: "kafka/consumer-group-lag-summarize-success.golden", wantErrCode: 0, env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group lag summarize consumer-group-1 --cluster lkc-groups", fixture: "kafka/rest-proxy-not-available.golden", wantErrCode: 1},
		...
		{args: "kafka consumer-group lag list", fixture: "kafka/consumer-group-lag-list-no-args.golden", wantErrCode: 1, env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group lag list consumer-group-1 --cluster lkc-groups", fixture: "kafka/consumer-group-lag-list-success.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group lag list consumer-group-1 --cluster lkc-groups", fixture: "kafka/rest-proxy-not-available.golden", wantErrCode: 1},
		{args: "kafka consumer-group lag list consumer-group-1 --cluster lkc-groups -o json", fixture: "kafka/consumer-group-lag-list-success-json.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group lag list consumer-group-1 --cluster lkc-groups -o yaml", fixture: "kafka/consumer-group-lag-list-success-yaml.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},

		{args: "kafka consumer-group lag get --help", fixture: "kafka/consumer-group-lag-get.golden"},
		{args: "kafka consumer-group lag get", fixture: "kafka/consumer-group-lag-get-no-args.golden", wantErrCode: 1, env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group lag get consumer-group-1 --cluster lkc-groups --topic topic-1 --partition 1", fixture: "kafka/consumer-group-lag-get-success.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group lag get consumer-group-1 --cluster lkc-groups --topic topic-1 --partition 1", fixture: "kafka/rest-proxy-not-available.golden", wantErrCode: 1},
