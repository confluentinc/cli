...
func (s *CLITestSuite) TestKafkaLink() {
	tests := []CLITest{
		...
		{args: "kafka link describe link-5 --cluster lkc-describe-topic --include-tasks", fixture: "kafka/link/describe-link-with-tasks.golden", useKafka: "lkc-describe-topic"},
		{args: "kafka link describe link-5 --cluster lkc-describe-topic", fixture: "kafka/link/describe-link-without-tasks.golden", useKafka: "lkc-describe-topic"},
...
func (s *CLITestSuite) TestKafkaMirror() {
	tests := []CLITest{
		...
		{args: "kafka mirror describe topic-1 --link link-1 --cluster lkc-describe-topic --include-state-transition-errors", fixture: "kafka/mirror/describe-mirror-with-state-transition-errors.golden", useKafka: "lkc-describe-topic"},
