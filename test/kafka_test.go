...
func (s *CLITestSuite) TestKafka() {
	...
	tests := []CLITest{
		...
		{args: "kafka link list --cluster lkc-links", fixture: "kafka20.golden", wantErrCode: 0},
		{args: "kafka link list --cluster lkc-links -o json", fixture: "kafka21.golden", wantErrCode: 0},
		{args: "kafka link list --cluster lkc-links -o yaml", fixture: "kafka22.golden", wantErrCode: 0},
		{args: "kafka link describe --cluster lkc-links my-link", fixture: "kafka23.golden", wantErrCode: 0},
		{args: "kafka link describe --cluster lkc-links my-link -o json", fixture: "kafka24.golden", wantErrCode: 0},
		{args: "kafka link describe --cluster lkc-links my-link -o yaml", fixture: "kafka25.golden", wantErrCode: 0},
