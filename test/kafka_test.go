...
func (s *CLITestSuite) TestKafka() {
	...
	tests := []CLITest{
		...
		{args: "kafka consumer-group describe --help", fixture: "kafka/consumer-group-describe.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		...
		{args: "kafka consumer-group describe consumer-group-1", fixture: "kafka/consumer-group-describe-no-cluster.golden", wantErrCode: 1, env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		...
		{args: "kafka consumer-group lag summarize --help", fixture: "kafka/consumer-group-lag-summarize.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		...
		{args: "kafka consumer-group lag list --help", fixture: "kafka/consumer-group-lag-list.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		...
		{args: "kafka consumer-group lag get --help", fixture: "kafka/consumer-group-lag-get.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
