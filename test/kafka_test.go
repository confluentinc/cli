...
func (s *CLITestSuite) TestKafkaConsumerStreamGroup() {
	tests := []CLITest{
		...
		{args: "kafka consumer stream-group member list --group streams-group-1 --cluster lkc-1234", fixture: "kafka/consumer/stream-group/member-list.golden"},
		{args: "kafka consumer stream-group member list --group streams-group-1 --cluster lkc-1234 -o json", fixture: "kafka/consumer/stream-group/member-list-json.golden"},
		{args: "kafka consumer stream-group member describe member-1 --group streams-group-1 --cluster lkc-1234", fixture: "kafka/consumer/stream-group/member-describe.golden"},

		{args: "kafka consumer stream-group member-assignment describe member-1 --group streams-group-1 --cluster lkc-1234", fixture: "kafka/consumer/stream-group/assignment-describe.golden"},
		{args: "kafka consumer stream-group member-assignment list --group streams-group-1 --member member-1 --assignment active --cluster lkc-1234", fixture: "kafka/consumer/stream-group/assignment-task-list.golden"},

		{args: "kafka consumer stream-group member-target-assignment describe member-1 --group streams-group-1 --cluster lkc-1234", fixture: "kafka/consumer/stream-group/target-assignment-describe.golden"},
		{args: "kafka consumer stream-group member-target-assignment list --group streams-group-1 --member member-1 --assignment active --cluster lkc-1234", fixture: "kafka/consumer/stream-group/target-assignment-task-list.golden"},

		{args: "kafka consumer stream-group member-task-partitions describe member-1 --group streams-group-1 --subtopology subtopology-1 --assignment-type active --cluster lkc-1234", fixture: "kafka/consumer/stream-group/task-partitions-describe.golden"},

		{args: "kafka consumer stream-group member-target-assignment-task-partitions describe member-1 --group streams-group-1 --subtopology subtopology-1 --assignment-type active --cluster lkc-1234", fixture: "kafka/consumer/stream-group/target-task-partitions-describe.golden"},

		{args: "kafka consumer stream-group subtopology list --group streams-group-1 --cluster lkc-1234", fixture: "kafka/consumer/stream-group/subtopology-list.golden"},
		{args: "kafka consumer stream-group subtopology list --group streams-group-1 --cluster lkc-1234 -o json", fixture: "kafka/consumer/stream-group/subtopology-list-json.golden"},
		{args: "kafka consumer stream-group subtopology describe subtopology-1 --group streams-group-1 --cluster lkc-1234", fixture: "kafka/consumer/stream-group/subtopology-describe.golden"},
	}
