...
func (s *CLITestSuite) TestKafkaLink() {
	tests := []CLITest{
		...
		{args: "kafka link describe link-5 --cluster lkc-describe-topic -o json", fixture: "kafka/link/describe-link-with-tasks-json.golden", useKafka: "lkc-describe-topic"},
		{args: "kafka link describe link-5 --cluster lkc-describe-topic -o yaml", fixture: "kafka/link/describe-link-with-tasks-yaml.golden", useKafka: "lkc-describe-topic"},
