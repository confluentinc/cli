...
func (s *CLITestSuite) TestKafka() {
	tests := []CLITest{
		...
		{args: "kafka cluster list", fixture: "kafka/cluster/list-deletion-protection-all.golden"},
		{args: "kafka cluster list --deletion-protection", fixture: "kafka/cluster/list-deletion-protection-enabled.golden"},
		{args: "kafka cluster list --deletion-protection=true", fixture: "kafka/cluster/list-deletion-protection-enabled.golden"},
		{args: "kafka cluster list --deletion-protection=false", fixture: "kafka/cluster/list-deletion-protection-disabled.golden"},
