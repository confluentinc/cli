...
func (s *CLITestSuite) TestKafkaLink() {
	tests := []CLITest{
		...
		{args: "kafka link tasks describe link-5 --cluster lkc-describe-topic", fixture: "kafka/link/describe-link-with-tasks.golden", useKafka: "lkc-describe-topic"},
		{args: "kafka link tasks describe link-5 --cluster lkc-describe-topic -o json", fixture: "kafka/link/describe-link-with-tasks-json.golden", useKafka: "lkc-describe-topic"},
		{args: "kafka link tasks describe link-5 --cluster lkc-describe-topic -o yaml", fixture: "kafka/link/describe-link-with-tasks-yaml.golden", useKafka: "lkc-describe-topic"},
...
func (s *CLITestSuite) TestKafkaMirror() {
	tests := []CLITest{
		...
		{args: "kafka mirror state-transition-errors describe topic-1 --link link-1 --cluster lkc-describe-topic", fixture: "kafka/mirror/describe-mirror-with-state-transition-errors.golden", useKafka: "lkc-describe-topic"},
		{args: "kafka mirror state-transition-errors describe topic-1 --link link-1 --cluster lkc-describe-topic -o json", fixture: "kafka/mirror/describe-mirror-with-state-transition-errors-json.golden", useKafka: "lkc-describe-topic"},
		{args: "kafka mirror state-transition-errors describe topic-1 --link link-1 --cluster lkc-describe-topic -o yaml", fixture: "kafka/mirror/describe-mirror-with-state-transition-errors-yaml.golden", useKafka: "lkc-describe-topic"},
