...
func (s *CLITestSuite) TestKafka() {
	...
	tests := []CLITest{
		...
		//
		//{args: "kafka consumer-group list", fixture: "kafka/consumer-group-list.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		{args: "kafka consumer-group list --cluster lkc-describe-topic", fixture: "kafka/consumer-group-list-success.golden", wantErrCode: 0, useKafka: "lkc-describe-topic", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group list --cluster lkc-groups -o json", fixture: "kafka/consumer-group-list-success-json.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group list --cluster lkc-groups -o yaml", fixture: "kafka/consumer-group-list-success-yaml.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group list --cluster lkc-no-groups", fixture: "kafka/consumer-group-empty-list.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//
		//{args: "kafka consumer-group describe", fixture: "kafka/consumer-group-describe.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group describe --cluster lkc-groups", fixture: "kafka/consumer-group-describe-no-group.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group describe consumer-group-1", fixture: "kafka/consumer-group-describe-no-cluster.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group describe consumer-group-1 --cluster lkc-groups", fixture: "kafka/consumer-group-describe-success.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group describe consumer-group-1 --cluster lkc-groups -o json", fixture: "kafka/consumer-group-describe-success-json.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group describe consumer-group-1 --cluster lkc-groups -o yaml", fixture: "kafka/consumer-group-describe-success-yaml.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group describe consumer-group-1 --cluster lkc-no-groups", fixture: "kafka/consumer-group-empty-describe.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//
		//{args: "kafka consumer-group lag --help", fixture: "kafka/consumer-group-lag-help.golden"},
		//
		//{args: "kafka consumer-group lag summarize", fixture: "kafka/consumer-group-lag-summarize.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag summarize consumer-group-1 --cluster lkc-describe-topic", fixture: "kafka/consumer-group-lag-summarize-success.golden", wantErrCode: 0, useKafka: "lkc-describe-topic", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag summarize consumer-group-1 --cluster lkc-groups -o json", fixture: "kafka/consumer-group-lag-summarize-success-json.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag summarize consumer-group-1 --cluster lkc-groups -o yaml", fixture: "kafka/consumer-group-lag-summarize-success-yaml.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag summarize consumer-group-1 --cluster lkc-no-groups", fixture: "kafka/consumer-group-empty-lag-summarize.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//
		//{args: "kafka consumer-group lag list", fixture: "kafka/consumer-group-lag-list.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag list --cluster lkc-groups", fixture: "kafka/consumer-group-lag-list-success.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag list --cluster lkc-groups -o json", fixture: "kafka/consumer-group-lag-list-success-json.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag list --cluster lkc-groups -o yaml", fixture: "kafka/consumer-group-lag-list-success-yaml.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag list --cluster lkc-no-groups", fixture: "kafka/consumer-group-empty-lag-list.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//
		//{args: "kafka consumer-group lag get", fixture: "kafka/consumer-group-lag-get.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag get --cluster lkc-groups", fixture: "kafka/consumer-group-lag-get-no-group.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag get consumer-group-1", fixture: "kafka/consumer-group-lag-get-no-cluster.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag get consumer-group-1 --cluster lkc-groups --topic topic-1 --partition 0", fixture: "kafka/consumer-group-lag-get-success.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag get consumer-group-1 --cluster lkc-groups --topic topic-1 --partition 0 -o json", fixture: "kafka/consumer-group-lag-get-success-json.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag get consumer-group-1 --cluster lkc-groups --topic topic-1 --partition 0 -o yaml", fixture: "kafka/consumer-group-lag-get-success-yaml.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
		//{args: "kafka consumer-group lag get consumer-group-1 --cluster lkc-no-groups", fixture: "kafka/consumer-group-empty-lag-describe.golden", env: []string{"XX_CCLOUD_USE_KAFKA_REST=true"}},
