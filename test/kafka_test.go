...
func (s *CLITestSuite) TestKafkaConsumerStreamGroup() {
	tests := []CLITest{
		...
		{args: "kafka streams-group member assignment list --group streams-group-1 --member member-1 --assignment-type active --cluster lkc-1234", fixture: "kafka/streams-group/assignment-task-list.golden"},
		...
		{args: "kafka streams-group member target-assignment list --group streams-group-1 --member member-1 --assignment-type active --cluster lkc-1234", fixture: "kafka/streams-group/target-assignment-task-list.golden"},

		{args: "kafka streams-group member assignment subtopology describe member-1 --group streams-group-1 --subtopology subtopology-1 --assignment-type active --cluster lkc-1234", fixture: "kafka/streams-group/task-partitions-describe.golden"},

		{args: "kafka streams-group member target-assignment subtopology describe member-1 --group streams-group-1 --subtopology subtopology-1 --assignment-type active --cluster lkc-1234", fixture: "kafka/streams-group/target-task-partitions-describe.golden"},
