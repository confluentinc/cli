...
func (s *CLITestSuite) TestKafka() {
	...
	tests := []CLITest{
		...
		{args: "kafka topic create topic1 --cluster lkc-create-topic", login: "default", fixture: "kafka/topic-create-success.golden"},
		...
		{args: "kafka topic describe topic1 --cluster lkc-describe-topic", login: "default", fixture: "kafka/topic-describe-success.golden"},
		...
		{args: "kafka topic delete topic1 --cluster lkc-delete-topic", login: "default", fixture: "kafka/topic-delete-success.golden"},
