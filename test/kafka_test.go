...
func (s *CLITestSuite) TestKafkaCommands() {
	...
	tests := []CLITest{
		...
		//{args: "kafka link list -o json", fixture: "kafka21.golden", wantErrCode: 0},
		//{args: "kafka link list -o yaml", fixture: "kafka22.golden", wantErrCode: 0},
		//{args: "kafka link describe my-link", fixture: "kafka23.golden", wantErrCode: 0},
		//{args: "kafka link describe my-link -o json", fixture: "kafka24.golden", wantErrCode: 0},
		//{args: "kafka link describe my-link -o yaml", fixture: "kafka25.golden", wantErrCode: 0},
	}
