...
func (s *CLITestSuite) TestEnvironmentUpdate_PackageDowngrade() {
	tests := []CLITest{
		{args: "environment update env-595 --governance-package essentials", login: "cloud", fixture: "environment/update-governance-package-downgrade-fail.golden", exitCode: 1},
	}
