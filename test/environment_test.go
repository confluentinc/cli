...
func (s *CLITestSuite) TestEnvironment() {
	tests := []CLITest{
		...
		{args: "environment update env-595 --name new-other-name --stream-governance advanced",
			fixture: "environment/3.golden"},
		...
		{args: "environment create saucayyy -o json --stream-governance advanced", fixture: "environment/9.golden"},
