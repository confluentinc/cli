...
define aws-authenticate
	$(if $(DRY_RUN),echo "[DRY RUN] aws-authenticate",source ~/git/go/src/github.com/confluentinc/cc-dotfiles/caas.sh && if ! aws sts get-caller-identity; then eval $$(gimme-aws-creds --output-format export --roles "arn:aws:iam::050879227952:role/administrator"); fi)
endef
