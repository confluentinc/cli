...
gorelease:
	...
	cat dist/confluent_$(VERSION_NO_V)_checksums_linux.txt >> dist/confluent_$(VERSION_NO_V)_checksums_tmp.txt && \
	...
	cat dist/confluent_$(VERSION_NO_V)_checksums.txt >> dist/confluent_$(VERSION_NO_V)_checksums_tmp.txt && \
	aws s3 cp dist/confluent_$(VERSION_NO_V)_checksums_tmp.txt $(S3_STAG_PATH)/confluent-cli/archives/$(VERSION_NO_V)/confluent_$(VERSION)_checksums.txt && \
	aws s3 cp dist/confluent_$(VERSION_NO_V)_checksums_tmp.txt $(S3_STAG_PATH)/confluent-cli/binaries/$(VERSION_NO_V)/confluent_$(VERSION_NO_V)_checksums.txt && \
