...
define aws-authenticate
	$(if $(DRY_RUN),echo "[DRY RUN] aws-authenticate",source ~/git/go/src/github.com/confluentinc/cc-dotfiles/caas.sh && AWS_PROFILE=cc-production-1/prod-administrator aws sts get-caller-identity >/dev/null)
endef
