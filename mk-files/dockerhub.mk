...
publish-dockerhub:
	...
	docker build --no-cache -f ./mk-files/Dockerfile_ccloud -t confluentinc/ccloud-cli:$(CLEAN_VERSION) -t confluentinc/ccloud-cli:latest ./mk-files/
	...
	docker build --no-cache -f ./mk-files/Dockerfile_confluent -t confluentinc/confluent-cli:$(CLEAN_VERSION) -t confluentinc/confluent-cli:latest ./mk-files/
