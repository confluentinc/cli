...
// Source: pkg/local/confluent_home.go
...
type MockConfluentHome struct {
	...
	ReadServiceConfigFunc func(service string, zookeeperMode bool) ([]byte, error)

	lockReadServicePort sync.Mutex
	ReadServicePortFunc func(service string, zookeeperMode bool) (int, error)

	lockGetVersion sync.Mutex
	GetVersionFunc func(service string, zookeeperMode bool) (string, error)
...
func (m *MockConfluentHome) ReadServiceConfig(service string, zookeeperMode bool) ([]byte, error) {
	...
	call := struct {
		...
		Service:       service,
		ZookeeperMode: zookeeperMode,
	}

	m.calls.ReadServiceConfig = append(m.calls.ReadServiceConfig, call)

	return m.ReadServiceConfigFunc(service, zookeeperMode)
}
...
func (m *MockConfluentHome) ReadServicePort(service string, zookeeperMode bool) (int, error) {
	...
	return m.ReadServicePortFunc(service, zookeeperMode)
}
...
func (m *MockConfluentHome) GetVersion(service string, zookeeperMode bool) (string, error) {
	...
	return m.GetVersionFunc(service, zookeeperMode)
}
