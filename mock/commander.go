...
func NewPreRunnerMock(client *ccloud.Client, cmkClient *cmk.APIClient, mdsClient *mds.APIClient, kafkaRESTProvider *pcmd.KafkaRESTProvider, cfg *v1.Config) pcmd.PreRunner {
