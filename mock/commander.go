...
func NewPreRunnerMock(client *ccloud.Client, cmkClient *cmkv2.APIClient, mdsClient *mds.APIClient, kafkaRESTProvider *pcmd.KafkaRESTProvider, cfg *v1.Config) pcmd.PreRunner {
