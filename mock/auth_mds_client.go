...
type MDSClientManager struct {
	...
	GetMDSClientFunc func(url, caCertPath, clientCertPath, clientKeyPath string, unsafeTrace bool) (*github_com_confluentinc_mds_sdk_go_public_mdsv1.APIClient, error)
...
func (m *MDSClientManager) GetMDSClient(url, caCertPath, clientCertPath, clientKeyPath string, unsafeTrace bool) (*github_com_confluentinc_mds_sdk_go_public_mdsv1.APIClient, error) {
	...
	return m.GetMDSClientFunc(url, caCertPath, clientCertPath, clientKeyPath, unsafeTrace)
}
