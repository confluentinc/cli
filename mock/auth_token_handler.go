...
type MockAuthTokenHandler struct {
	...
	GetCCloudTokensFunc func(client *github_com_confluentinc_ccloud_sdk_go_v1.Client, credentials *github_com_confluentinc_cli_internal_pkg_auth.Credentials, noBrowser bool, orgResourceId string) (string, string, error)
...
func (m *MockAuthTokenHandler) GetCCloudTokens(client *github_com_confluentinc_ccloud_sdk_go_v1.Client, credentials *github_com_confluentinc_cli_internal_pkg_auth.Credentials, noBrowser bool, orgResourceId string) (string, string, error) {
	...
	return m.GetCCloudTokensFunc(client, credentials, noBrowser, orgResourceId)
}
