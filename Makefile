...
lint-go:
	...
	golangci-lint run --enable dupword,gofmt,goimports,gomoddirectives,govet,ineffassign,misspell,nolintlint,prealloc,unparam,unused,usestdlibvars,whitespace --timeout=10m
	@echo "✅  golangci-lint"
