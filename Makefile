...
lint-go:
	...
	golangci-lint run --enable dupword,gci,gofmt,goimports,gomoddirectives,govet,ineffassign,misspell,nolintlint,prealloc,tenv,unparam,unused,usestdlibvars,whitespace --timeout=10m
	@echo "✅  golangci-lint"
