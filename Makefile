...
lint-go:
	...
	golangci-lint run --enable dupword,exportloopref,gocritic,gofmt,goimports,gomoddirectives,govet,ineffassign,misspell,nakedret,nolintlint,prealloc,tenv,unparam,unused,usestdlibvars,whitespace --timeout=10m
	@echo "✅  golangci-lint"
