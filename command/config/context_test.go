...
// disabled for now since context will not be part of the preview release.
//import (
//	"os"
//	"testing"
//
...
//output, err = run("context", "set", "my-context", "--kafka-cluster-id", "bob")
//req.NoError(err)
//req.Empty(output)
...
//output, err = run("context", "get", "bob")
//req.NoError(err)
