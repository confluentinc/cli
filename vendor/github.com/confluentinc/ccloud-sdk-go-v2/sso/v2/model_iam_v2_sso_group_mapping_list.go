...
type IamV2SsoGroupMappingList struct {
	...
	Data []IamV2SsoGroupMapping `json:"data,omitempty"`
}
...
func (o *IamV2SsoGroupMappingList) Redact() {
...
func (o *IamV2SsoGroupMappingList) recurseRedact(v interface{}) {
...
func (o IamV2SsoGroupMappingList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o IamV2SsoGroupMappingList) MarshalJSON() ([]byte, error) {
...
type NullableIamV2SsoGroupMappingList struct {
	value *IamV2SsoGroupMappingList
	isSet bool
}

func (v NullableIamV2SsoGroupMappingList) Get() *IamV2SsoGroupMappingList {
	return v.value
}

func (v *NullableIamV2SsoGroupMappingList) Set(val *IamV2SsoGroupMappingList) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2SsoGroupMappingList) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2SsoGroupMappingList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2SsoGroupMappingList(val *IamV2SsoGroupMappingList) *NullableIamV2SsoGroupMappingList {
	return &NullableIamV2SsoGroupMappingList{value: val, isSet: true}
}

func (v NullableIamV2SsoGroupMappingList) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableIamV2SsoGroupMappingList) UnmarshalJSON(src []byte) error {
	v.isSet = true
