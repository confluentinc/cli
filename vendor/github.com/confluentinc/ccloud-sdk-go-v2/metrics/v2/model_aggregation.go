...
func (o *Aggregation) GetAgg() AggregationFunction {
	if o == nil || o.Agg.Get() == nil {
		var ret AggregationFunction
		return ret
	}
	return *o.Agg.Get()
}

// GetAggOk returns a tuple with the Agg field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o *Aggregation) Redact() {
    ...
    o.recurseRedact(o.Agg)
}

func (o *Aggregation) recurseRedact(v interface{}) {
...
func (o Aggregation) zeroField(v interface{}) {
