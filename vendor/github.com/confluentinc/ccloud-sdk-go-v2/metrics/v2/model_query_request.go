...
func NewQueryRequest(aggregations []Aggregation, granularity Granularity, intervals []string) *QueryRequest {
	...
	var limit int32 = 100
	this.Limit = &limit
	var format ResponseFormat = FLAT
	this.Format = &format
	return &this
}
...
func (o QueryRequest) zeroField(v interface{}) {
