...
func (o *AttributesRequest) recurseRedact(v interface{}) {
...
func (o AttributesRequest) zeroField(v interface{}) {
...
func (v NullableAttributesRequest) Get() *AttributesRequest {
	return v.value
}

func (v *NullableAttributesRequest) Set(val *AttributesRequest) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAttributesRequest(val *AttributesRequest) *NullableAttributesRequest {
	return &NullableAttributesRequest{value: val, isSet: true}
}
