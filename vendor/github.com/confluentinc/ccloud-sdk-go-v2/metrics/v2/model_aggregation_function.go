...
func (v *AggregationFunction) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := AggregationFunction(value)
	for _, existing := range AllowedAggregationFunctionEnumValues {
	...
	return fmt.Errorf("%+v is not a valid AggregationFunction", value)
}

// NewAggregationFunctionFromValue returns a pointer to a valid AggregationFunction
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewAggregationFunctionFromValue(v string) (*AggregationFunction, error) {
	ev := AggregationFunction(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for AggregationFunction: valid values are %v", v, AllowedAggregationFunctionEnumValues)
	}
}
...
func (v AggregationFunction) Ptr() *AggregationFunction {
	return &v
}
...
func (v NullableAggregationFunction) Get() *AggregationFunction {
	return v.value
}

func (v *NullableAggregationFunction) Set(val *AggregationFunction) {
	v.value = val
	v.isSet = true
}

func (v NullableAggregationFunction) IsSet() bool {
	return v.isSet
}
...
func NewNullableAggregationFunction(val *AggregationFunction) *NullableAggregationFunction {
	return &NullableAggregationFunction{value: val, isSet: true}
}
