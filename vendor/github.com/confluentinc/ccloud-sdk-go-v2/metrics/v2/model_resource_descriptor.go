...
func (o *ResourceDescriptor) recurseRedact(v interface{}) {
...
func (o ResourceDescriptor) zeroField(v interface{}) {
...
func (v NullableResourceDescriptor) Get() *ResourceDescriptor {
	return v.value
}

func (v *NullableResourceDescriptor) Set(val *ResourceDescriptor) {
	v.value = val
	v.isSet = true
}
...
func NewNullableResourceDescriptor(val *ResourceDescriptor) *NullableResourceDescriptor {
	return &NullableResourceDescriptor{value: val, isSet: true}
}
