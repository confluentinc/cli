...
func (o *LabelDescriptor) Redact() {
    ...
    o.recurseRedact(o.Exportable)
}

func (o *LabelDescriptor) recurseRedact(v interface{}) {
...
func (o LabelDescriptor) zeroField(v interface{}) {
...
func (v NullableLabelDescriptor) Get() *LabelDescriptor {
	return v.value
}

func (v *NullableLabelDescriptor) Set(val *LabelDescriptor) {
	v.value = val
	v.isSet = true
}
...
func NewNullableLabelDescriptor(val *LabelDescriptor) *NullableLabelDescriptor {
	return &NullableLabelDescriptor{value: val, isSet: true}
}
