...
type _GroupedQueryResponseDataInner GroupedQueryResponseDataInner
...
func NewGroupedQueryResponseDataInner(points []Point) *GroupedQueryResponseDataInner {
	this := GroupedQueryResponseDataInner{}
	this.Points = points
	return &this
}
...
func (o *GroupedQueryResponseDataInner) Redact() {
    o.recurseRedact(&o.Points)
}

func (o *GroupedQueryResponseDataInner) recurseRedact(v interface{}) {
...
func (o GroupedQueryResponseDataInner) zeroField(v interface{}) {
...
func (o *GroupedQueryResponseDataInner) UnmarshalJSON(bytes []byte) (err error) {
	varGroupedQueryResponseDataInner := _GroupedQueryResponseDataInner{}

	if err = json.Unmarshal(bytes, &varGroupedQueryResponseDataInner); err == nil {
		*o = GroupedQueryResponseDataInner(varGroupedQueryResponseDataInner)
	}
...
type NullableGroupedQueryResponseDataInner struct {
	value *GroupedQueryResponseDataInner
	isSet bool
}

func (v NullableGroupedQueryResponseDataInner) Get() *GroupedQueryResponseDataInner {
	return v.value
}

func (v *NullableGroupedQueryResponseDataInner) Set(val *GroupedQueryResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupedQueryResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupedQueryResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupedQueryResponseDataInner(val *GroupedQueryResponseDataInner) *NullableGroupedQueryResponseDataInner {
	return &NullableGroupedQueryResponseDataInner{value: val, isSet: true}
}
