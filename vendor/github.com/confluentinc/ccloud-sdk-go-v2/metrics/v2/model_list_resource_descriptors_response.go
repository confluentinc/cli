...
func NewListResourceDescriptorsResponse(data []ResourceDescriptor, meta Meta) *ListResourceDescriptorsResponse {
	this := ListResourceDescriptorsResponse{}
	this.Data = data
	this.Meta = meta
	return &this
}
...
func (o *ListResourceDescriptorsResponse) Redact() {
    ...
    o.recurseRedact(&o.Meta)
    o.recurseRedact(o.Links)
}

func (o *ListResourceDescriptorsResponse) recurseRedact(v interface{}) {
...
func (o ListResourceDescriptorsResponse) zeroField(v interface{}) {
...
type NullableListResourceDescriptorsResponse struct {
	value *ListResourceDescriptorsResponse
	isSet bool
}

func (v NullableListResourceDescriptorsResponse) Get() *ListResourceDescriptorsResponse {
	return v.value
}

func (v *NullableListResourceDescriptorsResponse) Set(val *ListResourceDescriptorsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListResourceDescriptorsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListResourceDescriptorsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResourceDescriptorsResponse(val *ListResourceDescriptorsResponse) *NullableListResourceDescriptorsResponse {
	return &NullableListResourceDescriptorsResponse{value: val, isSet: true}
}
