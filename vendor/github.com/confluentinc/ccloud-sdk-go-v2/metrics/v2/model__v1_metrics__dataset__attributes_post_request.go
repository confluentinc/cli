...
func NewV1MetricsDatasetAttributesPostRequest(metric string, groupBy []string) *V1MetricsDatasetAttributesPostRequest {
	this := V1MetricsDatasetAttributesPostRequest{}
	this.Metric = metric
...
func (o *V1MetricsDatasetAttributesPostRequest) Redact() {
    o.recurseRedact(&o.Metric)
    o.recurseRedact(&o.GroupBy)
    o.recurseRedact(o.Filter)
    o.recurseRedact(o.Intervals)
    o.recurseRedact(o.Limit)
}

func (o *V1MetricsDatasetAttributesPostRequest) recurseRedact(v interface{}) {
...
func (o V1MetricsDatasetAttributesPostRequest) zeroField(v interface{}) {
...
type NullableV1MetricsDatasetAttributesPostRequest struct {
	value *V1MetricsDatasetAttributesPostRequest
	isSet bool
}

func (v NullableV1MetricsDatasetAttributesPostRequest) Get() *V1MetricsDatasetAttributesPostRequest {
	return v.value
}

func (v *NullableV1MetricsDatasetAttributesPostRequest) Set(val *V1MetricsDatasetAttributesPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableV1MetricsDatasetAttributesPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableV1MetricsDatasetAttributesPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1MetricsDatasetAttributesPostRequest(val *V1MetricsDatasetAttributesPostRequest) *NullableV1MetricsDatasetAttributesPostRequest {
	return &NullableV1MetricsDatasetAttributesPostRequest{value: val, isSet: true}
}

func (v NullableV1MetricsDatasetAttributesPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1MetricsDatasetAttributesPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
