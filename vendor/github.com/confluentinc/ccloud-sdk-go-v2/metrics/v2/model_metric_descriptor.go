...
// GetExportableOk returns a tuple with the Exportable field value
// and a boolean to check if the value has been set.
...
func (o *MetricDescriptor) Redact() {
    ...
    o.recurseRedact(&o.LifecycleStage)
    o.recurseRedact(&o.Exportable)
    o.recurseRedact(&o.Resources)
}

func (o *MetricDescriptor) recurseRedact(v interface{}) {
...
func (o MetricDescriptor) zeroField(v interface{}) {
...
func (o MetricDescriptor) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["lifecycle_stage"] = o.LifecycleStage
	}
	if true {
