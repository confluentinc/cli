...
func (o *GroupedQueryResponse) GetData() []GroupedQueryResponseDataInner {
	if o == nil {
		var ret []GroupedQueryResponseDataInner
		return ret
	}
...
func (o *GroupedQueryResponse) recurseRedact(v interface{}) {
...
func (o GroupedQueryResponse) zeroField(v interface{}) {
...
type NullableGroupedQueryResponse struct {
	value *GroupedQueryResponse
	isSet bool
}

func (v NullableGroupedQueryResponse) Get() *GroupedQueryResponse {
	return v.value
}

func (v *NullableGroupedQueryResponse) Set(val *GroupedQueryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupedQueryResponse) IsSet() bool {
	return v.isSet
}
...
func NewNullableGroupedQueryResponse(val *GroupedQueryResponse) *NullableGroupedQueryResponse {
	return &NullableGroupedQueryResponse{value: val, isSet: true}
}
