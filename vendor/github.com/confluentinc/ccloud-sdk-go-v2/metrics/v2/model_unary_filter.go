...
func (o *UnaryFilter) recurseRedact(v interface{}) {
...
func (o UnaryFilter) zeroField(v interface{}) {
...
func (v NullableUnaryFilter) Get() *UnaryFilter {
	return v.value
}
...
func NewNullableUnaryFilter(val *UnaryFilter) *NullableUnaryFilter {
	return &NullableUnaryFilter{value: val, isSet: true}
}
