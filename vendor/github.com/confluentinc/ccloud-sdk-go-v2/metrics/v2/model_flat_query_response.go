...
func (o *FlatQueryResponse) recurseRedact(v interface{}) {
...
func (o FlatQueryResponse) zeroField(v interface{}) {
...
type NullableFlatQueryResponse struct {
	value *FlatQueryResponse
	isSet bool
}

func (v NullableFlatQueryResponse) Get() *FlatQueryResponse {
	return v.value
}

func (v *NullableFlatQueryResponse) Set(val *FlatQueryResponse) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFlatQueryResponse(val *FlatQueryResponse) *NullableFlatQueryResponse {
	return &NullableFlatQueryResponse{value: val, isSet: true}
}
