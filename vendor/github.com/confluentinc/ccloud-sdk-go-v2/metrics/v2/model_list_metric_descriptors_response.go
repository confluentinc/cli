...
func NewListMetricDescriptorsResponse(data []MetricDescriptor, meta Meta) *ListMetricDescriptorsResponse {
	this := ListMetricDescriptorsResponse{}
	this.Data = data
	this.Meta = meta
	return &this
}
...
func (o *ListMetricDescriptorsResponse) recurseRedact(v interface{}) {
...
func (o ListMetricDescriptorsResponse) zeroField(v interface{}) {
...
type NullableListMetricDescriptorsResponse struct {
	value *ListMetricDescriptorsResponse
	isSet bool
}

func (v NullableListMetricDescriptorsResponse) Get() *ListMetricDescriptorsResponse {
	return v.value
}

func (v *NullableListMetricDescriptorsResponse) Set(val *ListMetricDescriptorsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListMetricDescriptorsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListMetricDescriptorsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListMetricDescriptorsResponse(val *ListMetricDescriptorsResponse) *NullableListMetricDescriptorsResponse {
	return &NullableListMetricDescriptorsResponse{value: val, isSet: true}
}
