...
type ApiV1MetricsDatasetAttributesPostRequest struct {
	...
	dataset string
	pageToken *string
	v1MetricsDatasetAttributesPostRequest *V1MetricsDatasetAttributesPostRequest
}

// The next page token. The token is returned by the previous request as part of &#x60;meta.pagination&#x60;.
func (r ApiV1MetricsDatasetAttributesPostRequest) PageToken(pageToken string) ApiV1MetricsDatasetAttributesPostRequest {
...
func (r ApiV1MetricsDatasetAttributesPostRequest) V1MetricsDatasetAttributesPostRequest(v1MetricsDatasetAttributesPostRequest V1MetricsDatasetAttributesPostRequest) ApiV1MetricsDatasetAttributesPostRequest {
	r.v1MetricsDatasetAttributesPostRequest = &v1MetricsDatasetAttributesPostRequest
	return r
}

func (r ApiV1MetricsDatasetAttributesPostRequest) Execute() (*AttributesResponse, *http.Response, error) {
	return r.ApiService.V1MetricsDatasetAttributesPostExecute(r)
}
...
func (a *Version1ApiService) V1MetricsDatasetAttributesPostExecute(r ApiV1MetricsDatasetAttributesPostRequest) (*AttributesResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Version1ApiService.V1MetricsDatasetAttributesPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/metrics/{dataset}/attributes"
	...
	// body params
	localVarPostBody = r.v1MetricsDatasetAttributesPostRequest
...
func (r ApiV1MetricsDatasetDescriptorsGetRequest) PageSize(pageSize int32) ApiV1MetricsDatasetDescriptorsGetRequest {
	r.pageSize = &pageSize
	return r
}

// The next page token. The token is returned by the previous request as part of &#x60;meta.pagination&#x60;.
func (r ApiV1MetricsDatasetDescriptorsGetRequest) PageToken(pageToken string) ApiV1MetricsDatasetDescriptorsGetRequest {
	r.pageToken = &pageToken
	return r
}

func (r ApiV1MetricsDatasetDescriptorsGetRequest) Execute() (*ListMetricDescriptorsResponse, *http.Response, error) {
	return r.ApiService.V1MetricsDatasetDescriptorsGetExecute(r)
}
...
//  @return ListMetricDescriptorsResponse
// Deprecated
func (a *Version1ApiService) V1MetricsDatasetDescriptorsGetExecute(r ApiV1MetricsDatasetDescriptorsGetRequest) (*ListMetricDescriptorsResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Version1ApiService.V1MetricsDatasetDescriptorsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/metrics/{dataset}/descriptors"
	localVarPath = strings.Replace(localVarPath, "{"+"dataset"+"}", url.PathEscape(parameterToString(r.dataset, "")), -1)
...
func (r ApiV1MetricsDatasetQueryPostRequest) QueryRequest(queryRequest QueryRequest) ApiV1MetricsDatasetQueryPostRequest {
	r.queryRequest = &queryRequest
	return r
}

func (r ApiV1MetricsDatasetQueryPostRequest) Execute() (*QueryResponse, *http.Response, error) {
	return r.ApiService.V1MetricsDatasetQueryPostExecute(r)
}
...
func (a *Version1ApiService) V1MetricsDatasetQueryPostExecute(r ApiV1MetricsDatasetQueryPostRequest) (*QueryResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Version1ApiService.V1MetricsDatasetQueryPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/metrics/{dataset}/query"
	localVarPath = strings.Replace(localVarPath, "{"+"dataset"+"}", url.PathEscape(parameterToString(r.dataset, "")), -1)
