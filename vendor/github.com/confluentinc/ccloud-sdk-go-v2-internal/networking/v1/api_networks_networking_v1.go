...
func (a *NetworksNetworkingV1ApiService) ListNetworkingV1NetworksExecute(r ApiListNetworkingV1NetworksRequest) (NetworkingV1NetworkList, *_nethttp.Response, error) {
	...
	if r.specCloud != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "spec.cloud", r.specCloud, "")
	}
	if r.specRegion != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "spec.region", r.specRegion, "")
	}
	if r.specCidr != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "spec.cidr", r.specCidr, "")
	}
