...
func (a *PrivateRBACUIManageRoleBindingsApiService) ClusterAccessInfo(ctx _context.Context, principal string, scope Scope) (ClusterAccessInfo, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ClusterAccessInfo
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/security/1.0/lookup/managed/clusters/principal/{principal}"
...
func (a *PrivateRBACUIManageRoleBindingsApiService) ManagedRoleBindings(ctx _context.Context, principal string, scope Scope, localVarOptionals *ManagedRoleBindingsOpts) (ManagedRoleBindings, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ManagedRoleBindings
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/security/1.0/lookup/managed/rolebindings/principal/{principal}"
	localVarPath = strings.Replace(localVarPath, "{"+"principal"+"}", _neturl.PathEscape(parameterToString(principal, "")), -1)
