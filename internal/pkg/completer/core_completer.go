...
type CoreCompleter struct {
	RootCmd *cobra.Command
}

func NewCoreCompleter(rootCmd *cobra.Command) *CoreCompleter {
	return &CoreCompleter{
		RootCmd: rootCmd,
	}
}

func (c *CoreCompleter) Complete(d prompt.Document) []prompt.Suggest {
	command := c.RootCmd
