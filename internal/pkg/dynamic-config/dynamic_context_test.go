...
func getBaseContext() *DynamicContext {
	...
	return NewDynamicContext(cfg.Context(), pmock.NewClientMock(), pmock.NewPublicClientMock(), pmock.NewV2ClientMock())
}

func getClusterFlagContext() *DynamicContext {
	config := v1.AuthenticatedCloudConfigMock()
	clusterFlagContext := NewDynamicContext(config.Context(), pmock.NewClientMock(), pmock.NewPublicClientMock(), pmock.NewV2ClientMock())
...
func getEnvFlagContext() *DynamicContext {
	config := v1.AuthenticatedCloudConfigMock()
	envFlagContext := NewDynamicContext(config.Context(), pmock.NewClientMock(), pmock.NewPublicClientMock(), pmock.NewV2ClientMock())
...
func getEnvAndClusterFlagContext() *DynamicContext {
	config := v1.AuthenticatedCloudConfigMock()
	envAndClusterFlagContext := NewDynamicContext(config.Context(), pmock.NewClientMock(), pmock.NewPublicClientMock(), pmock.NewV2ClientMock())
