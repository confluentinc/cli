...
func (c *Connect) List(ctx context.CfgContext, cluster *connectv1.ConnectCluster) ([]*connectv1.ConnectCluster, error) {
	c.Logger.Log("msg", "connect.List()")
	return c.Client.Connect.List(ctx, cluster)
}

func (c *Connect) Describe(ctx context.CfgContext, cluster *connectv1.ConnectCluster) (*connectv1.ConnectCluster, error) {
	c.Logger.Log("msg", "connect.Describe()")
	return c.Client.Connect.Describe(ctx, cluster)
}

func (c *Connect) DescribeS3Sink(ctx context.CfgContext, cluster *connectv1.ConnectS3SinkCluster) (*connectv1.ConnectS3SinkCluster, error) {
	c.Logger.Log("msg", "connect.DescribeS3Sink()")
	return c.Client.Connect.DescribeS3Sink(ctx, cluster)
}

func (c *Connect) CreateS3Sink(ctx context.CfgContext, cfg *connectv1.ConnectS3SinkClusterConfig) (*connectv1.ConnectS3SinkCluster, error) {
...
func (c *Connect) UpdateS3Sink(ctx context.CfgContext, cluster *connectv1.ConnectS3SinkCluster) (*connectv1.ConnectS3SinkCluster, error) {
	c.Logger.Log("msg", "connect.UpdateS3Sink()")
	return c.Client.Connect.UpdateS3Sink(ctx, cluster)
}

func (c *Connect) Delete(ctx context.CfgContext, cluster *connectv1.ConnectCluster) error {
