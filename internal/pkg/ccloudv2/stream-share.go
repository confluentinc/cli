...
func (c *Client) DescribeProvideShare(shareId string) (streamsharev1.CdxV1ProviderShare, *http.Response, error) {
...
func (c *Client) ListProviderShares(sharedResource, pageToken string) (streamsharev1.CdxV1ProviderShareList, *http.Response, error) {
