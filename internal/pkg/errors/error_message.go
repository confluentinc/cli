...
const (
	...
	SchemaNotSpecifiedSuggestions = `When value format is not "string", specify a schema by passing path to the schema file via "--schema" flag, or a registered schema Id via "--schema-id".`
