...
const (
	...
	ChooseRightEnvironmentSuggestions    = "Ensure the cluster you are specifying belongs to the currently selected environment with `ccloud kafka cluster list`, `ccloud environment list`, and `ccloud environment use`."
