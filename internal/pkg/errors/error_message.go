...
const (
	...
	FailedToReadPortsErrorMsg     = "failed to read ports from config"
	FailedToReadPortsSuggestions  = "Please restart Confluent Local with `confluent local kafka stop` and `confluent local kafka start`"
