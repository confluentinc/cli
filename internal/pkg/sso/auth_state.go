...
var (
	...
	//ssoProviderCallbackCCloudDevURL = "http://"+ssoProviderDomainDevel+"/cli_callback" // TODO UNCOMMENT WHEN DONE LOCAL TESTING
	ssoProviderCallbackCCloudDevURL = ssoProviderCallbackLocalURL
