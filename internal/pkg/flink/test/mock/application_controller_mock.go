...
// Source: internal/pkg/flink/internal/controller/application_controller.go
...
func (m *MockApplicationControllerInterface) AddCleanupFunction(arg0 func()) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AddCleanupFunction", arg0)
}
...
func (m *MockApplicationControllerInterface) StartTView(layout tview.Primitive) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StartTView", layout)
	ret0, _ := ret[0].(error)
	return ret0
}

// StartTView indicates an expected call of StartTView.
func (mr *MockApplicationControllerInterfaceMockRecorder) StartTView(layout interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StartTView", reflect.TypeOf((*MockApplicationControllerInterface)(nil).StartTView), layout)
}

// SuspendOutputMode mocks base method.
func (m *MockApplicationControllerInterface) SuspendOutputMode(callback func()) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SuspendOutputMode", callback)
}

// SuspendOutputMode indicates an expected call of SuspendOutputMode.
func (mr *MockApplicationControllerInterfaceMockRecorder) SuspendOutputMode(callback interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SuspendOutputMode", reflect.TypeOf((*MockApplicationControllerInterface)(nil).SuspendOutputMode), callback)
}
