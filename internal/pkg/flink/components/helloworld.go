...
func HelloWorld(nextSlide func(), app *tview.Application) (title string, params ExtraSlideParams, content tview.Primitive) {
	...
	return "Hello, world", ExtraSlideParams{}, Code(textView, 30, 10, helloWorld)
}
