...
func Colors(nextSlide func(), app *tview.Application) (title string, params ExtraSlideParams, content tview.Primitive) {
	...
	return "Colors", ExtraSlideParams{}, Center(78, 19, table)
}
