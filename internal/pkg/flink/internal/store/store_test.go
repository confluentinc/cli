...
func (s *StoreTestSuite) TestParseSETStatementerror() {
	...
	assert.Equal(s.T(), "Error: Missing \"=\".\nUsage example: SET 'key'='value'.", err.Error())
