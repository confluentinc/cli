...
func (t *InteractiveOutputController) updateTable() {
	t.tableView.RenderTable(t.getTableTitle(), t.resultFetcher.GetMaterializedStatementResults(), t.resultFetcher.GetLastFetchTimestamp(), t.resultFetcher.GetRefreshState())
	t.renderTableView()
}
