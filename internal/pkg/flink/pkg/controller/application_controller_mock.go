...
// Source: github.com/confluentinc/flink-sql-client/pkg/controller (interfaces: ApplicationControllerInterface)
...
func (m *MockApplicationControllerInterface) GetOutputMode() OutputMode {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOutputMode")
	ret0, _ := ret[0].(OutputMode)
	return ret0
}
