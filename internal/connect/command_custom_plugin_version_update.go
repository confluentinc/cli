...
func (c *customPluginCommand) newVersionUpdateCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				...
				Code: "confluent connect custom-plugin version update --plugin ccp-123456 --version ver-12345 --version-number 0.0.1 --beta=false --sensitive-properties=property1,property2",
			},
		),
	}
	...
	cmd.Flags().Bool("beta", false, "Specify the stability of the version. (default \"false\")")
