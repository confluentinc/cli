...
func (c *accessPointCommand) newPrivateNetworkInterfaceDeleteCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:               "delete <id-1> [id-2] ... [id-n]",
		Short:             "Delete one or more private network interfaces.",
		Args:              cobra.MinimumNArgs(1),
		ValidArgsFunction: pcmd.NewValidArgsFunction(c.validPrivateNetworkInterfaceArgsMultiple),
		RunE:              c.privateNetworkInterfaceDelete,
	}
...
func (c *accessPointCommand) privateNetworkInterfaceDelete(cmd *cobra.Command, args []string) error {
