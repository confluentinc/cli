...
func addForwarderFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringSlice("domain-mapping", []string{}, "Path to a domain mapping file containing domain mappings. Each mapping should have the format of domain=zone,project. Mappings are separated by new-line characters.")
}
