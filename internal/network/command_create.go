...
func (c *command) newCreateCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			...
			examples.Example{
				Text: `Create a Confluent network with a display name in AWS with connection type "transitgateway" by specifying zones and CIDR.`,
			...
			examples.Example{
				Text: `Create a Confluent network with a display name in AWS with connection types "transitgateway" and "peering" by specifying zones and CIDR.`,
			...
			examples.Example{
				Text: `Create a Confluent network with a display name in AWS with connection type "peering" by specifying zone info.`,
			...
			examples.Example{
				Text: `Create a Confluent network with a display name in GCP with connection type "peering" by specifying zones and CIDR.`,
			...
			examples.Example{
				Text: `Create a Confluent network with a display name in Azure with connection type "privatelink" by specifying DNS resolution.`,
