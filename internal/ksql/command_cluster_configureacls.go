...
func (c *ksqlCommand) newConfigureAclsCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				Text: "Configure ACLs for ksqlDB cluster lksql-12345 for topics topic_1 and topic_2:",
				Code: "confluent ksql cluster configureacls lksql-12345 topic_1 topic_2",
			},
		),
	}
