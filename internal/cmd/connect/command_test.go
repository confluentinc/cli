...
func (suite *ConnectTestSuite) TestCreateConnector() {
	cmd := suite.newCmd()
	cmd.SetArgs([]string{"cluster", "create", "--config", "../../../test/fixtures/input/connect/config.yaml"})
	buf := new(bytes.Buffer)
	cmd.SetOut(buf)
	err := cmd.Execute()
	req := require.New(suite.T())
...
func (suite *ConnectTestSuite) TestCreateConnectorNewFormat() {
	cmd := suite.newCmd()
	cmd.SetArgs([]string{"cluster", "create", "--config", "../../../test/fixtures/input/connect/config-new-format.json"})
	buf := new(bytes.Buffer)
	cmd.SetOut(buf)
	err := cmd.Execute()
	req := require.New(suite.T())
...
func (suite *ConnectTestSuite) TestCreateConnectorMalformedNewFormat() {
	cmd := suite.newCmd()
	cmd.SetArgs([]string{"cluster", "create", "--config", "../../../test/fixtures/input/connect/config-malformed-new.json"})
	err := cmd.Execute()
	req := require.New(suite.T())
	req.NotNil(err)
...
func (suite *ConnectTestSuite) TestCreateConnectorMalformedOldFormat() {
	cmd := suite.newCmd()
	cmd.SetArgs([]string{"cluster", "create", "--config", "../../../test/fixtures/input/connect/config-malformed-old.json"})
	err := cmd.Execute()
	req := require.New(suite.T())
	req.NotNil(err)
	req.Contains(err.Error(), "unable to parse config")
...
func (suite *ConnectTestSuite) TestUpdateConnector() {
	cmd := suite.newCmd()
	cmd.SetArgs([]string{"cluster", "update", connectorID, "--config", "../../../test/fixtures/input/connect/config.yaml"})
	buf := new(bytes.Buffer)
	cmd.SetOut(buf)
	err := cmd.Execute()
	req := require.New(suite.T())
