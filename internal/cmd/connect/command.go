...
func (c *command) init(cliName string) {
	describeCmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				...
				Code: fmt.Sprintf("%s connect describe <id>\n%s connect describe <id> --cluster <cluster-id>", cliName, cliName),
			},
		),
	}
	...
	listCmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				...
				Code: fmt.Sprintf("%s connect list\n%s connect list --cluster <cluster-id>", cliName, cliName),
			},
		),
	}
	...
	createCmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				...
				Code: fmt.Sprintf("%s connect create --config <file>\n%s connect create --cluster <cluster-id> --config <file>", cliName, cliName),
			},
		),
	}
	...
	deleteCmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				...
				Code: fmt.Sprintf("%s connect delete --config <file>\n%s connect delete --cluster <cluster-id> --config <file>", cliName, cliName),
			},
		),
	}
	...
	pauseCmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				...
				Code: fmt.Sprintf("%s connect pause --config <file>\n%s connect pause --cluster <cluster-id> --config <file>", cliName, cliName),
			},
		),
	}
	...
	resumeCmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				...
				Code: fmt.Sprintf("%s connect resume --config <file>\n%s connect resume --cluster <cluster-id> --config <file>", cliName, cliName),
			},
		),
	}
	...
	if cliName == "ccloud" {
		...
		c.AddCommand(NewPluginCommand(cliName, c.prerunner))
	} else {
