...
func (suite *ModeTestSuite) SetupSuite() {
...
func (suite *ModeTestSuite) SetupTest() {
...
func (suite *ModeTestSuite) newCMD() *cobra.Command {
...
func (suite *ModeTestSuite) TestModeUpdate() {
	cmd := suite.newCMD()
	cmd.SetArgs(append([]string{"mode", "update", "READWRITE"}))
