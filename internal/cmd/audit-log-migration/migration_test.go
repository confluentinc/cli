	...
	testCases := []struct {
	...
	}{
		{
			...
			[]string{
				...
				"Multiple Crn Authorities Warning: Cluster \"clusterABC\" had multiple CRN Authorities in its routes: [crn://mds1.example.com/ crn://diff-authority/].",
				"New Bootstrap Servers Warning: Cluster \"cluster123\" currently has bootstrap servers = [audit.example.com:9092]. Replacing with [new_bootstrap].",
				"New Bootstrap Servers Warning: Cluster \"clusterABC\" currently has bootstrap servers = [some-server]. Replacing with [new_bootstrap].",
