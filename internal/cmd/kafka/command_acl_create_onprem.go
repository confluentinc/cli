	...
	cmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				...
				Code: "confluent kafka acl create --allow --principal User:Jane --operations read --operations describe --consumer-group java_example_group_1",
			},
			examples.Example{
				Code: `confluent kafka acl create --allow --principal User:Jane --operations read --operations describe --topic "*"`,
			},
			examples.Example{
				...
				Code: "confluent kafka acl create --url http://localhost:8090/kafka --allow --principal User:Jane --operations read --operations describe --consumer-group java_example_group_1",
			},
			examples.Example{
				Code: `confluent kafka acl create --url http://localhost:8090/kafka --allow --principal User:Jane --operations read --operations describe --topic "*"`,
			},
			examples.Example{
				...
				Code: "confluent kafka acl create --url http://localhost:8082 --allow --principal User:Jane --operations read --operations describe --consumer-group java_example_group_1",
			},
			examples.Example{
				Code: `confluent kafka acl create --url http://localhost:8082 --allow --principal User:Jane --operations read --operations describe --topic "*"`,
			},
		),
	}
