	...
	cmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				...
				Code: `confluent kafka topic produce my-topic --url http://localhost:8090/kafka --bootstrap "localhost:18091" --ca-location my-cert.crt`,
			},
			examples.Example{
				Text: `Produce message to topic "my-topic" providing Kafka REST Proxy endpoint.`,
				Code: `confluent kafka topic produce my-topic --url http://localhost:8082 --bootstrap "localhost:18091" --ca-location my-cert.crt`,
			},
			examples.Example{
			...
			examples.Example{
				Text: `Produce message to topic "my-topic" with SSL protocol, and SSL verification enabled.`,
