...
func NewSaramaConsumer(group string, kafka *v0.KafkaClusterConfig, clientID string, beginning bool) (sarama.ConsumerGroup, error) {
...
func NewSaramaProducer(kafka *v0.KafkaClusterConfig, clientID string) (sarama.SyncProducer, error) {
...
func saramaConf(kafka *v0.KafkaClusterConfig, clientID string, beginning bool) (*sarama.Config, error) {
