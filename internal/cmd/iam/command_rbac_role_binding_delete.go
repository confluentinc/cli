	...
	if c.cfg.IsCloudLogin() {
		cmd.Example = examples.BuildExampleString(
			examples.Example{
				...
				Code: "confluent iam rbac role-binding delete --principal User:u-123456 --role ResourceOwner --environment env-12345 --cloud-cluster lkc-123456 --kafka-cluster lkc-123456 --resource Topic:my-topic",
			},
		)
	}
