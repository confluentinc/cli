...
func (c *roleBindingCommand) newCreateCommand() *cobra.Command {
	...
	if c.cfg.IsCloudLogin() {
		cmd.Example = examples.BuildExampleString(
			...
			examples.Example{
				Text: `Grant the role "ResourceOwner" to principal "User:u-123456" to all subjects for the |sr| “lsrc-123456” in the environment “env-12345”:`,
			...
			examples.Example{
				Text: `Grant the role "ResourceOwner" to principal "User:u-123456" to specific subject "test" for the |sr| “lsrc-123456” in the environment “env-12345”:`,
			...
			examples.Example{
				Text: `Grant the role "ResourceOwner" to principal "User:u-123456" to all subjects in the schema context "schema_context" for the |sr| “lsrc-123456” in the environment “env-12345”:`,
			...
			examples.Example{
				Text: `Grant the role "ResourceOwner" to principal "User:u-123456" to a specific subject "test" in the schema context "schema_context" for the |sr| “lsrc-123456” in the environment “env-12345”:`,
