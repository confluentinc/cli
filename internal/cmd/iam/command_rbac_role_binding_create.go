	...
	if c.cfg.IsCloudLogin() {
		cmd.Example = examples.BuildExampleString(
			...
			examples.Example{
				...
				Code: "confluent iam rbac role-binding create --principal User:u-123456 --role ResourceOwner --resource Topic:my-topic --environment env-12345 --cloud-cluster lkc-123456 --kafka-cluster lkc-123456",
			},
			examples.Example{
