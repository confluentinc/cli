	...
	if isCloud {
		example = examples.BuildExampleString(
			examples.Example{
				...
				Code: version.CLIName + " iam rolebinding list --current-user",
			},
			examples.Example{
				Text: "To list the role bindings for a specific principal:",
				Code: version.CLIName + " iam rolebinding list --principal User:frodo",
			},
			examples.Example{
				Text: "To list the role bindings for a specific principal, filtered to a specific role:",
				Code: version.CLIName + " iam rolebinding list --principal User:frodo --role CloudClusterAdmin --environment env-123 --cloud-cluster lkc-1111aaa",
			},
			examples.Example{
				Text: "To list the principals bound to a specific role:",
				Code: version.CLIName + " iam rolebinding list --role CloudClusterAdmin --current-env --cloud-cluster lkc-1111aaa",
			},
		)
	} else {
		example = examples.BuildExampleString(
			examples.Example{
				...
				Code: version.CLIName + " iam rolebinding list --kafka-cluster-id CID  --role DeveloperRead --resource Topic",
			},
			examples.Example{
				Text: "To list the role bindings for a specific principal:",
				Code: version.CLIName + " iam rolebinding list --kafka-cluster-id $CID --principal User:frodo",
			},
			examples.Example{
				Text: "To list the role bindings for a specific principal, filtered to a specific role:",
				Code: version.CLIName + " iam rolebinding list --kafka-cluster-id $CID --principal User:frodo --role DeveloperRead",
			},
			examples.Example{
				Text: "To list the principals bound to a specific role:",
				Code: version.CLIName + " iam rolebinding list --kafka-cluster-id $CID --role DeveloperWrite",
			},
			examples.Example{
				Text: "To list the principals bound to a specific resource with a specific role:",
				Code: version.CLIName + " iam rolebinding list --kafka-cluster-id $CID --role DeveloperWrite --resource Topic:shire-parties",
			},
		)
