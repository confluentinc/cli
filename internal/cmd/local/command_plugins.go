...
func NewPluginsCommand(prerunner cmd.PreRunner) *cobra.Command {
	...
	pluginsCommand.AddCommand(NewPluginsListCommand(prerunner))

	return pluginsCommand.Command
}

func NewPluginsListCommand(prerunner cmd.PreRunner) *cobra.Command {
