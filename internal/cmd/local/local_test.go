...
func TestLocal(t *testing.T) {
	...
	localCmd := New(&cobra.Command{}, cliMock.NewPreRunnerMock(nil, nil), shellRunner, log.New(), &mock.FileSystem{}, &config.Config{})
...
func TestLocalCommandSuggestions(t *testing.T) {
	...
	root.AddCommand(New(root, cliMock.NewPreRunnerMock(nil, nil), shellRunner, log.New(), &mock.FileSystem{}, &config.Config{}))
