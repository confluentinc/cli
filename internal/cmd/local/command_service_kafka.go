		...
		&cobra.Command{
			...
			Example: examples.BuildExampleString(
				examples.Example{
					...
					Code: pversion.CLIName + " local services kafka consume mytopic1 --value-format avro --from-beginning",
				},
				examples.Example{
					Text: "Consume newly arriving non-Avro data from a topic called `mytopic2` on a development Kafka cluster on localhost.",
					Code: pversion.CLIName + " local services kafka consume mytopic2",
				},
				examples.Example{
				...
				examples.Example{
					...
					Code: pversion.CLIName + " local services kafka consume mytopic3 --cloud --config /tmp/myconfig.properties --from-beginning",
				},
				examples.Example{
					...
					Code: pversion.CLIName + " local services kafka consume mytopic4 --cloud --config /tmp/myconfig.properties --from-beginning --property print.key=true",
				},
				examples.Example{
					...
					Code: pversion.CLIName + " local services kafka consume mytopic5 --cloud --config /tmp/myconfig.properties --value-format avro \\\n--from-beginning --property schema.registry.url=http://localhost:8081",
				},
				examples.Example{
		...
		&cobra.Command{
			...
			Example: examples.BuildExampleString(
				examples.Example{
					...
					Code: pversion.CLIName + " local services kafka produce mytopic1 --value-format avro --property value.schema='{\"type\":\"record\",\"name\":\"myrecord\",\"fields\":[{\"name\":\"f1\",\"type\":\"string\"}]}'",
				},
				examples.Example{
					Text: "Produce non-Avro data to a topic called `mytopic2` on a development Kafka cluster on localhost:",
					Code: pversion.CLIName + " local produce mytopic2",
				},
				examples.Example{
				...
				examples.Example{
					...
					Code: pversion.CLIName + " local services kafka produce mytopic3 --cloud --config /tmp/myconfig.properties",
				},
				examples.Example{
					...
					Code: pversion.CLIName + " local services kafka produce mytopic4 --cloud --config /tmp/myconfig.properties --property parse.key=true --property key.separator=,",
				},
				examples.Example{
					...
					Code: pversion.CLIName + ` local services kafka produce mytopic5 --cloud --config /tmp/myconfig.properties --value-format avro --property \\\nvalue.schema='{"type":"record","name":"myrecord","fields":[{"name":"f1","type":"string"}]}' \\\n--property schema.registry.url=http://localhost:8081`,
				},
				examples.Example{
