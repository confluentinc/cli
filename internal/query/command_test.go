...
func TestResolveDatabase(t *testing.T) {
	...
	// Neither flag given: falls back to the CLI's active Kafka cluster context
	// (`confluent kafka cluster use`), the same "flag, then context" chain
	// environment and compute pool already follow.
