...
func (c *connectClusterCommand) newDescribeCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:               "describe <id>",
		Short:             "Describe a USM Connect cluster.",
...
func (c *connectClusterCommand) describe(cmd *cobra.Command, args []string) error {
	id := args[0]
	...
	connectCluster, httpResp, err := c.V2Client.GetUsmConnectCluster(id, environmentId)
	if err != nil {
