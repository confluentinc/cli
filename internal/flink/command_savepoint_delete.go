...
func (c *command) newSavepointDeleteCommand() *cobra.Command {
	...
	cmd.Flags().String("application", "", "The Name of the application from which to delete the savepoint.")
	cmd.Flags().String("statement", "", "The Name of the statement from which to delete the savepoint.")
	addCmfFlagSet(cmd)
