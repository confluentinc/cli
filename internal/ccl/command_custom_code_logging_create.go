	...
	cmd := &cobra.Command{
		...
		Example: examples.BuildExampleString(
			examples.Example{
				...
				Code: "confluent ccl custom-code-logging create --cloud aws --region us-west-2 --environment env-000000 --destination-kafka --topic topic-123 --cluster-id cluster-123",
			},
		),
	}
