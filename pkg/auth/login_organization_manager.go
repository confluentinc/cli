//go:generate go run go.uber.org/mock/mockgen -typed -destination=../../mock/login_organization_manager.go -package=mock github.com/confluentinc/cli/v4/pkg/auth LoginOrganizationManager
package auth
