...
func TestParseApplicationOptionsFromSlices(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			configKeys:   []string{"UnsafeTrace", "UserAgent", "Environment", "EnvironmentName", "OrganizationId", "Database", "ComputePoolId", "ServiceAccount", "Verbose", "LSPBaseUrl", "GatewayUrl"},
