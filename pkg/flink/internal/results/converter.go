...
import (
	flinkgatewayv1vbeta1 "github.com/confluentinc/ccloud-sdk-go-v2/flink-gateway/v1beta1"
...
func GetConverterForType(dataType flinkgatewayv1vbeta1.DataType) SDKToStatementResultFieldConverter {
	...
	case types.MULTISET:
		...
		valueType := flinkgatewayv1vbeta1.DataType{
			Nullable: false,
			Type:     "INTEGER",
		}
...
func toArrayStatementResultFieldConverter(elementType flinkgatewayv1vbeta1.DataType) SDKToStatementResultFieldConverter {
...
func toMapStatementResultFieldConverter(fieldType types.StatementResultFieldType, keyType, valueType flinkgatewayv1vbeta1.DataType) SDKToStatementResultFieldConverter {
...
func toRowStatementResultFieldConverter(elementTypes []flinkgatewayv1vbeta1.RowFieldType) SDKToStatementResultFieldConverter {
	return func(field any) types.StatementResultField {
