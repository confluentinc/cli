...
func GetConverterForType(dataType flinkgatewayv1.DataType) (SDKToStatementResultFieldConverter, types.StatementResultFieldType, error) {
	...
	case types.Row:
		converter, err = toRowStatementResultFieldConverter(dataType.GetFields())
	case types.StructuredType:
		converter, err = toStructuredStatementResultFieldConverter(dataType.GetFields())
	default:
...
func GetConverterForTypeOnPrem(dataType cmfsdk.DataType) (SDKToStatementResultFieldConverter, types.StatementResultFieldType, error) {
	...
	case types.Row:
		converter, err = toRowStatementResultFieldConverterOnPrem(dataType.GetFields())
	case types.StructuredType:
		converter, err = toStructuredStatementResultFieldConverterOnPrem(dataType.GetFields())
	default:
		converter = toAtomicStatementResultFieldConverter(fieldType)
	}
	if err != nil {
...
func toMapStatementResultFieldConverter(fieldType types.StatementResultFieldType, keyType, valueType flinkgatewayv1.DataType) (SDKToStatementResultFieldConverter, error) {
	keyToStatementResultFieldConverter, resultKeyType, err := GetConverterForType(keyType)
	if err != nil {
		return nil, err
	}
	valueToStatementResultFieldConverter, resultValueType, err := GetConverterForType(valueType)
	if err != nil {
		return nil, err
	}
	return func(field any) (types.StatementResultField, error) {
...
func toMapStatementResultFieldConverterOnPrem(fieldType types.StatementResultFieldType, keyType, valueType cmfsdk.DataType) (SDKToStatementResultFieldConverter, error) {
	keyToStatementResultFieldConverter, resultKeyType, err := GetConverterForTypeOnPrem(keyType)
	if err != nil {
		return nil, err
	}
	valueToStatementResultFieldConverter, resultValueType, err := GetConverterForTypeOnPrem(valueType)
	if err != nil {
		return nil, err
	}
	return func(field any) (types.StatementResultField, error) {
...
func toStructuredStatementResultFieldConverterOnPrem(fieldTypes []cmfsdk.DataTypeField) (SDKToStatementResultFieldConverter, error) {
	return func(field any) (types.StatementResultField, error) {
		structuredField, ok := field.([]any)
		if !ok || len(structuredField) != len(fieldTypes) {
			return nullField, nil
