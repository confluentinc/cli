...
func (m *MockStoreInterface) ProcessLocalStatement(arg0 string) (*types.ProcessedStatement, *types.StatementError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProcessLocalStatement", arg0)
	ret0, _ := ret[0].(*types.ProcessedStatement)
	ret1, _ := ret[1].(*types.StatementError)
	return ret0, ret1
}
...
func (mr *MockStoreInterfaceMockRecorder) ProcessLocalStatement(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessLocalStatement", reflect.TypeOf((*MockStoreInterface)(nil).ProcessLocalStatement), arg0)
}
