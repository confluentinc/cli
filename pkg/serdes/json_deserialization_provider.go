...
func (a *JsonDeserializationProvider) InitDeserializer(srClientUrl, mode string) error {
...
func (a *JsonDeserializationProvider) Deserialize(topic string, payload []byte, msg interface{}) error {
