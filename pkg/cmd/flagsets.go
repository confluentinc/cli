...
func OnPremKafkaRestSet() *pflag.FlagSet {
	...
	set.String("certificate-authority-path", "", "Path to a PEM-encoded Certificate Authority to verify the Confluent REST Proxy.")
...
func OnPremAuthenticationSet() *pflag.FlagSet {
	...
	set.String("certificate-authority-path", "", "File or directory path to one or more Certificate Authority certificates for verifying the broker's key with SSL.")
