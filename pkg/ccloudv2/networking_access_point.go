...
func (c *Client) ListNetworkAccessPoints(environment string, names []string) ([]networkingaccesspointv1.NetworkingV1AccessPoint, error) {
	var list []networkingaccesspointv1.NetworkingV1AccessPoint

	done := false
	pageToken := ""
	for !done {
		page, err := c.executeListNetworkAccessPoints(environment, pageToken, names)
		if err != nil {
			return nil, err
		}
...
func (c *Client) executeListNetworkAccessPoints(environment, pageToken string, names []string) (networkingaccesspointv1.NetworkingV1AccessPointList, error) {
...
func (c *Client) GetNetworkAccessPoint(environment, id string) (networkingaccesspointv1.NetworkingV1AccessPoint, error) {
...
func (c *Client) DeleteNetworkAccessPoint(environment, id string) error {
...
func (c *Client) UpdateNetworkAccessPoint(id string, accessPointUpdate networkingaccesspointv1.NetworkingV1AccessPointUpdate) (networkingaccesspointv1.NetworkingV1AccessPoint, error) {
...
func (c *Client) CreateNetworkAccessPoint(accessPoint networkingaccesspointv1.NetworkingV1AccessPoint) (networkingaccesspointv1.NetworkingV1AccessPoint, error) {
...
func (c *Client) ListNetworkDnsRecords(environment string, listParameters DnsRecordListParameters) ([]networkingaccesspointv1.NetworkingV1DnsRecord, error) {
	...
	pageToken := ""
	for !done {
		page, err := c.executeListNetworkDnsRecords(environment, pageToken, listParameters)
		if err != nil {
			return nil, err
		}
		list = append(list, page.GetData()...)
...
func (c *Client) executeListNetworkDnsRecords(environment, pageToken string, listParameters DnsRecordListParameters) (networkingaccesspointv1.NetworkingV1DnsRecordList, error) {
...
func (c *Client) GetNetworkDnsRecord(environment, id string) (networkingaccesspointv1.NetworkingV1DnsRecord, error) {
...
func (c *Client) DeleteNetworkDnsRecord(environment, id string) error {
...
func (c *Client) UpdateNetworkDnsRecord(id string, dnsRecordUpdate networkingaccesspointv1.NetworkingV1DnsRecordUpdate) (networkingaccesspointv1.NetworkingV1DnsRecord, error) {
