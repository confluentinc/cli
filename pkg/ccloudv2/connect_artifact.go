...
func (c *Client) GetArtifactPresignedUrl(request camv1.CamV1PresignedUrlRequest) (camv1.ConnectV1PresignedUrl, error) {
	resp, httpResp, err := c.ConnectArtifactClient.PresignedUrlsConnectV1Api.PresignedUploadUrlCamV1PresignedUrl(c.connectArtifactApiContext()).ConnectV1PresignedUrlRequest(request).Execute()
...
func (c *Client) CreateConnectArtifact(createArtifactRequest camv1.CamV1ConnectArtifact) (camv1.CamV1ConnectArtifact, error) {
	resp, httpResp, err := c.ConnectArtifactClient.CustomArtifactConnectV1Api.CreateCamV1ConnectArtifact(c.connectArtifactApiContext()).CamV1ConnectArtifact(createArtifactRequest).Execute()
	return resp, errors.CatchCCloudV2Error(err, httpResp)
}
...
func (c *Client) DescribeConnectArtifact(cloud, region, environment, id string) (camv1.CamV1ConnectArtifact, error) {
	resp, httpResp, err := c.ConnectArtifactClient.CustomArtifactConnectV1Api.GetCamV1ConnectArtifact(c.connectArtifactApiContext(), id).Cloud(cloud).Region(region).Environment(environment).Execute()
	return resp, errors.CatchCCloudV2Error(err, httpResp)
}

func (c *Client) DeleteConnectArtifact(cloud, region, environment, id string) error {
	httpResp, err := c.ConnectArtifactClient.CustomArtifactConnectV1Api.DeleteCamV1ConnectArtifact(c.connectArtifactApiContext(), id).Cloud(cloud).Region(region).Environment(environment).Execute()
...
func (c *Client) UpdateConnectArtifact(id string, updateArtifactRequest camv1.CamV1ConnectArtifactUpdate) (camv1.CamV1ConnectArtifact, error) {
	resp, httpResp, err := c.ConnectArtifactClient.CustomArtifactConnectV1Api.UpdateCamV1ConnectArtifact(c.connectArtifactApiContext(), id).CamV1ConnectArtifactUpdate(updateArtifactRequest).Execute()
	return resp, errors.CatchCCloudV2Error(err, httpResp)
}
...
func (c *Client) executeListConnectArtifacts(pageToken, cloud, region, env string) (camv1.CamV1ConnectArtifactList, *http.Response, error) {
	req := c.ConnectArtifactClient.CustomArtifactConnectV1Api.ListCamV1ConnectArtifacts(c.connectArtifactApiContext()).PageSize(ccloudV2ListPageSize)
	if pageToken != "" {
