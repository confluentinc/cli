//go:generate go run go.uber.org/mock/mockgen -typed -destination=../../mock/confluent_home.go -package=mock github.com/confluentinc/cli/v4/pkg/local ConfluentHome
