...
var (
	...
	vocabWords = []string{
		...
		"io", "json", "jsonschema", "kafka", "ksql", "lifecycle", "lz4", "mds", "multi-zone", "netrc", "on-prem", "pem",
		"plaintext", "producer.config", "protobuf", "rbac", "readwrite", "recv", "rolebinding", "rolebindings",
